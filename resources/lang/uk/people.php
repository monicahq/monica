...
return [
    ...
    'people_list_lastactivitydateOldtoNew' => 'Сортувати за датою останньої активност, і від старіших до новіших',
    ...
    'people_add_middlename' => 'По батькові (необов\'язково)',
    'people_add_lastname' => 'Прізвище (необов\'язково)',
    'people_add_email' => 'Електронна пошта (необов\'язково)',
    ...
    // Stay in touch
    'stay_in_touch' => 'Підтримуйте зв\'язок',
    'stay_in_touch_frequency' => 'Зв\'язуйтеся кожного дня|Зв\'язуйтеся кожні {count} днів',
