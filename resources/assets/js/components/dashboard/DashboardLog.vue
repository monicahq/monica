    ...
    <div class="pa3">
      ...
      <ul v-if="activeTab == 'calls'">
        <li class="pb2" v-for="call in calls">
          ...
          <span class="black-50 mr1 f6">{{ call.called_at }}</span> <span class="mr1 black-50">•</span>
          <a :href="'/people/' + call.contact_id">{{ call.name }}</a>
        </li>
      </ul>

      <!-- Notes -->
      <div v-if="activeTab == 'notes'">
        <div class="pb3 cf" v-for="note in notes">
          <div class="fl w-10">
            <avatar v-bind:contact="note.contact"></avatar>
          </div>
