...
return [
    ...
    'relationship_type_partner_male_with_name' => 'partner di :name',
    ...
    'relationship_type_inlovewith_male_with_name' => 'qualcuno di cui :name è innamorato',

    'relationship_type_lovedby' => 'amato da',
    'relationship_type_lovedby_female' => 'amata da',
    'relationship_type_lovedby_male' => 'amato da',
    ...
    'relationship_type_lovedby_male_with_name' => 'amante segreto di :name',

    'relationship_type_ex' => 'ex compagno/a',
    'relationship_type_ex_female' => 'ex-fidanzata',
    'relationship_type_ex_male' => 'ex-fidanzato',
    'relationship_type_ex_with_name' => 'Ex compagno/a di :name',
    'relationship_type_ex_female_with_name' => 'ex-fidanzata di :name',
    'relationship_type_ex_male_with_name' => 'Ex fidanzato di :name',

    'relationship_type_parent' => 'genitore',
    'relationship_type_parent_female' => 'madre',
    'relationship_type_parent_male' => 'padre',
    'relationship_type_parent_with_name' => 'Genitore di :name',
    'relationship_type_parent_female_with_name' => 'madre di :name',
    'relationship_type_parent_male_with_name' => 'Padre di :name',

    'relationship_type_child' => 'bambino/a',
    'relationship_type_child_female' => 'figlia',
    'relationship_type_child_male' => 'figlio',
    'relationship_type_child_with_name' => 'Bambino/a di :name',
    'relationship_type_child_female_with_name' => 'figlia di :name',
    'relationship_type_child_male_with_name' => 'Figlio di :name',

    'relationship_type_stepparent' => 'genitore adottivo',
    'relationship_type_stepparent_female' => 'madrigna',
    'relationship_type_stepparent_male' => 'padre adottivo',
    'relationship_type_stepparent_with_name' => 'Genitore adottivo di :name',
    'relationship_type_stepparent_female_with_name' => ':name della matrigna',
    'relationship_type_stepparent_male_with_name' => 'Padre adottivo di :name',

    'relationship_type_stepchild' => 'figlio/a adottivo',
    'relationship_type_stepchild_female' => 'figliastra',
    'relationship_type_stepchild_male' => 'figlio adottivo',
    'relationship_type_stepchild_with_name' => 'Figlio/a adottivo/a di :name',
    'relationship_type_stepchild_female_with_name' => ':name della figliastra',
    'relationship_type_stepchild_male_with_name' => 'Figlio adottivo di :name',

    'relationship_type_sibling' => 'fratello/sorella',
    'relationship_type_sibling_female' => 'sorella',
    'relationship_type_sibling_male' => 'fratello',
    'relationship_type_sibling_with_name' => 'Fratello/Sorella di :name',
    'relationship_type_sibling_female_with_name' => 'sorella di :name',
    'relationship_type_sibling_male_with_name' => 'Fratello di :name',

    'relationship_type_grandparent' => 'nonno/a',
    'relationship_type_grandparent_female' => 'nonna',
    'relationship_type_grandparent_male' => 'nonno',
    'relationship_type_grandparent_with_name' => 'Nonno/a di :name',
    'relationship_type_grandparent_female_with_name' => 'Nonna di :name',
    'relationship_type_grandparent_male_with_name' => 'Nonno di :name',

    'relationship_type_grandchild' => 'nipote',
    'relationship_type_grandchild_female' => 'nipote',
    'relationship_type_grandchild_male' => 'nipote',
    'relationship_type_grandchild_with_name' => 'Nipote di :name',
    'relationship_type_grandchild_female_with_name' => 'Nipotina di :name',
    'relationship_type_grandchild_male_with_name' => 'Nipotino di :name',

    'relationship_type_uncle' => 'zio',
    'relationship_type_uncle_female' => 'zia',
    'relationship_type_uncle_male' => 'zio',
    'relationship_type_uncle_with_name' => 'zio di :name',
    'relationship_type_uncle_female_with_name' => 'zia di :name',
    'relationship_type_uncle_male_with_name' => 'zio di :name',

    'relationship_type_nephew' => 'nipote',
    'relationship_type_nephew_female' => 'nipote',
    'relationship_type_nephew_male' => 'nipote',
    'relationship_type_nephew_with_name' => 'nipote di :name',
    'relationship_type_nephew_female_with_name' => 'nipote di :name',
    'relationship_type_nephew_male_with_name' => 'nipote di :name',
    ...
    'relationship_type_godfather_with_name' => 'Padrino/Madrina di :name',
    'relationship_type_godfather_female_with_name' => ': nome della madrina',
    'relationship_type_godfather_male_with_name' => 'Padrino di :name',

    'relationship_type_godson' => 'figlioccio/a',
    'relationship_type_godson_female' => 'figlioccia',
    'relationship_type_godson_male' => 'figlioccio',
    'relationship_type_godson_with_name' => 'Figlioccio/a di :name',
    'relationship_type_godson_female_with_name' => 'figlioccia di :name',
    'relationship_type_godson_male_with_name' => 'Figlioccio di :name',

    'relationship_type_friend' => 'amico',
    'relationship_type_friend_female' => 'amico',
    'relationship_type_friend_male' => 'amico',
    'relationship_type_friend_with_name' => 'amico di :name',
    'relationship_type_friend_female_with_name' => 'amica di :name',
    'relationship_type_friend_male_with_name' => 'amico di :name',

    'relationship_type_bestfriend' => 'miglior amico',
    'relationship_type_bestfriend_female' => 'miglior amico',
    'relationship_type_bestfriend_male' => 'migliore amico',
    ...
    'relationship_type_bestfriend_male_with_name' => 'migliore amico di :name',
    ...
    'relationship_type_subordinate_male_with_name' => 'dipendente di :name',

    'relationship_type_mentor' => 'mentore',
    'relationship_type_mentor_female' => 'mentrice',
    'relationship_type_mentor_male' => 'mentore',
    'relationship_type_mentor_with_name' => 'mentore di :name',
    'relationship_type_mentor_female_with_name' => 'mentrice di :name',
    'relationship_type_mentor_male_with_name' => 'mentore di :name',

    'relationship_type_protege' => 'protetto',
    'relationship_type_protege_female' => 'protetta',
    'relationship_type_protege_male' => 'protégé',
    'relationship_type_protege_with_name' => 'Protetto di :name',
    'relationship_type_protege_female_with_name' => 'Protetta di :name',
    ...
    'relationship_type_ex_husband_male_with_name' => 'Ex marito di :name',
    ...
    'weather_clear' => 'Chiaro',
    'weather_clear-day' => 'Chiara',
    'weather_clear-night' => 'Notte limpida',
    'weather_light-drizzle' => 'Pioggia leggera',
    'weather_patchy-light-drizzle' => 'Pioggerellina irregolare',
    'weather_patchy-light-rain' => 'Pioggia leggera e irregolare',
    'weather_light-rain' => 'Pioggia leggera',
    'weather_moderate-rain-at-times' => 'Pioggia moderata e intermittente',
    'weather_moderate-rain' => 'Pioggia moderata',
    'weather_patchy-rain-possible' => 'Possibile pioggia a tratti',
    'weather_heavy-rain-at-times' => 'Forte pioggia intermittente',
    'weather_heavy-rain' => 'Forte pioggia',
    'weather_light-freezing-rain' => 'Pioggia leggere e ghiaccio',
    'weather_moderate-or-heavy-freezing-rain' => 'Pioggia ghiacciata forte o moderata',
    'weather_light-sleet' => 'Nevischio',
    'weather_moderate-or-heavy-rain-shower' => 'Pioggia moderata o pesante',
    'weather_light-rain-shower' => 'Leggeri rovesci di pioggia',
    'weather_torrential-rain-shower' => 'Pioggia torrenziale',
    'weather_rain' => 'Pioggia',
    'weather_snow' => 'Neve',
    'weather_blowing-snow' => 'Bufera di neve',
    'weather_patchy-light-snow' => 'Pioggia irregolare',
    'weather_light-snow' => 'Nevischio',
    'weather_patchy-moderate-snow' => 'Nevicate moderate e irregolari',
    'weather_moderate-snow' => 'Neve moderata',
    'weather_patchy-heavy-snow' => 'Forti nevicate',
    'weather_heavy-snow' => 'Forte nevicata',
    'weather_light-snow-showers' => 'Nevicate leggere',
    'weather_moderate-or-heavy-snow-showers' => 'Neve moderata o pesante',
    'weather_patchy-snow-possible' => 'Possibile pioggia a tratti',
    'weather_patchy-sleet-possible' => 'Possibile pioggia a tratti',
    'weather_moderate-or-heavy-sleet' => 'Forte o moderato nevischio',
    'weather_light-sleet-showers' => 'Leggeri rovesci di nevischio',
    'weather_moderate-or-heavy-sleet-showers' => 'Nevischio moderato',
    'weather_sleet' => 'Nevischio',
    'weather_wind' => 'Vento',
    'weather_fog' => 'Nebbia',
    'weather_freezing-fog' => 'Nebbia',
    'weather_mist' => 'Nebbia',
    'weather_blizzard' => 'Bora',
    'weather_overcast' => 'Coperto',
    'weather_cloudy' => 'Nuvoloso',
    'weather_partly-cloudy-day' => 'Parzialmente nuvoloso',
    'weather_partly-cloudy-night' => 'Parzialmente nuvolosa',
    'weather_freezing-drizzle' => 'Pioggerella',
    'weather_heavy-freezing-drizzle' => 'Pioggia fine ghiacciata e intensa',
    'weather_patchy-freezing-drizzle-possible' => 'Pioggerella ghiacciata e irregolare nelle vicinanze',
    'weather_ice-pellets' => 'Grandine',
    'weather_light-showers-of-ice-pellets' => 'Leggeri rovesci di grandine',
    'weather_moderate-or-heavy-showers-of-ice-pellets' => 'Pesanti grandinate',
    'weather_thundery-outbreaks-possible' => 'Thundery outbreaks possible',
    'weather_patchy-light-rain-with-thunder' => 'Pioggia leggera e irregolare in zona con temporali',
    'weather_moderate-or-heavy-rain-with-thunder' => 'Pioggia forte o moderata in zona con temporali',
    'weather_patchy-light-snow-with-thunder' => 'Pioggia leggera e irregolare in zona con temporali',
    'weather_moderate-or-heavy-snow-with-thunder' => 'Pioggia forte o moderata in zona con temporali',
