...
return [
    ...
    'tab_debts' => 'Χρέη',
    'tab_debts_blank' => 'Δεν έχετε καταγράψει ακόμη χρέη.',
    'tab_tasks' => 'Εργασίες',
    'tab_tasks_blank' => 'Δεν έχετε ακόμα καμία εργασία.',
    ...
    'statistics_contacts' => 'Επαφές',
    'statistics_activities' => 'Δραστηριότητες',
    'statistics_gifts' => 'Δώρα',

    'reminders_next_months' => 'Γεγονότα τους επόμενους 3 μήνες',
    'reminders_none' => 'Δεν υπάρχουν υπενθυμίσεις για αυτό το μήνα.',

    'product_changes' => 'Αλλαγές προϊόντος',
    'product_view_details' => 'Προβολή λεπτομερειών',
];
