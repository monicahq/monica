...
return [
    ...
    'subscriptions_help_opensource_desc' => 'مونيكا مشروع مفتوح مصدر. و هذا يعني بأنه صُنع بواسطة مجتمع خيري تماماً، الذي يريد توفير أداة عظيمة لتحقيق الصالح العام فقط. بما أنه مفتوح المصدر فيعني أن لغته البرمجية متاحة عاماً في GitHub، والجميع يمكن أن يتفقده، تعديله أو تعزيزه. جميع الأموال التي نكسبها مكرسة لبناء أفضل الميزات، للحصول على خوادم أكثر قوة، و المساعدة في دفع الفواتير. شكراً لمساعدتكم. لم نكن سنفعل ذلك بدونكم – حرفياً.',
    ...
    'import_report_status_imported' => 'تم الاستيراد',
