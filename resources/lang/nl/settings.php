...
return [
    ...
    'api_oauth_clients_desc2' => 'Gebruik deze client-id om een nieuwe token aan te vragen en autorisatiecodes om te zetten naar tokens. Zie <a href="{url}">Laravel Passport documentatie</a> voor meer uitleg.',
