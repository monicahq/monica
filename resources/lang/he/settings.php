...
return [
    ...
    'api_oauth_clients_desc2' => 'יש להשתמש במזהה לקוח זה כדי לבקש אסימון חדש ולהמיר את הקודים למטרת גישה לאסימוני גישה. יש לעיין ב<a href="{url}">תיעוד שלLaravel Passport</a> לקבלת הסברים נוספים.',
