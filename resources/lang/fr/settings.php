...
return [
    ...
    'delete_desc' => 'Voulez-vous supprimer votre compte ? Attention : la suppression est permanente et toutes vos données seront définitivement supprimées. Votre abonnement (le cas échéant) sera également immédiatement annulé.',
    'delete_other_desc' => 'Pour être clair : vos données dans la base de données principale seront supprimées immédiatement. Cependant, comme décrit dans notre politique de confidentialité, nous faisons des sauvegardes quotidiennes de la base de données en cas de panne et cette sauvegarde est conservée pendant 30 jours, puis elle est complètement supprimée. Il n’est pas réaliste d’imaginer que nous puissions aller dans toutes les sauvegardes pour supprimer vos données spécifiques. Soit dit en passant, ces données sont chiffrées sur des serveurs Amazon très sécurisés et personne n’a la clé de chiffrement, sauf nous. Par conséquent, vos données disparaîtront complètement dans 30 jours de toutes les sauvegardes, et personne ne saura que ces données ont jamais existé en premier lieu.',
    ...
    'subscriptions_account_cancel' => 'Vous pouvez <a href=":url">annuler l’abonnement</a> quand vous le souhaitez.',
    ...
    'import_upload_rule_instructions' => 'Instructions d’export pour <a href=":url1" target="_blank" rel="noopener noreferrer">Contacts.app (macOS)</a> et <a href=":url2" target="_blank" rel="noopener noreferrer">Google Contacts</a>.',
    ...
    'archive_title' => 'Archiver tous vos contacts de votre compte',
