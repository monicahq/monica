<div class="ba b--near-white br2 bg-gray-monica pa3 mb3 f6">
  ...
  <p class="mb0">
    <a href="/people/{{ $contact->$contact->hashID() }}/relationships/new?type={{ $contact->account->getRelationshipTypeByType('partner')->id }}">{{ trans('app.add') }}</a>
  </p>
</div>
...
<div class="ba b--near-white br2 bg-gray-monica pa3 mb3 f6">
  <div class="w-100 dt">
   ...
   <p class="mb0">
    <a href="/people/{{ $contact->$contact->hashID() }}/relationships/new?type={{ $contact->account->getRelationshipTypeByType('child')->id }}">{{ trans('app.add') }}</a>
  </p>
</div>
...
<div class="ba b--near-white br2 bg-gray-monica pa3 mb3 f6">
  <div class="w-100 dt">
   ...
   <p class="mb0">
    <a href="/people/{{ $contact->$contact->hashID() }}/relationships/new?type={{ $contact->account->getRelationshipTypeByType('friend')->id }}">{{ trans('app.add') }}</a>
  </p>
</div>
