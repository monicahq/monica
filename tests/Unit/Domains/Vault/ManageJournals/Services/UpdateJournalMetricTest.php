...
class UpdateJournalMetricTest extends TestCase
{
    use DatabaseTransactions;

    /** @test */
    public function it_updates_a_journal_metric(): void
    {
    ...
    public function it_fails_if_wrong_parameters_are_given(): void
    {
        ...
        (new UpdateJournalMetric)->execute($request);
    }
    ...
    private function executeService(User $author, Account $account, Vault $vault, Journal $journal, JournalMetric $journalMetric): void
    {
        ...
        $journalMetric = (new UpdateJournalMetric)->execute($request);
