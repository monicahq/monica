...
return [
    ...
    'api_oauth_clients_desc2' => 'Utilizza questo id client per richiedere un nuovo token e convertire i codici di autorizzazione a token di accesso. Vedi la <a href="{url}">documentazione di Laravel Passport</a> per ulteriori spiegazioni.',
