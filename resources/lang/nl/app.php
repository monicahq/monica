...
return [
    ...
    'relationship_type_partner_with_name' => ': naam van partner',
    'relationship_type_partner_female_with_name' => ':naam van partner',

    'relationship_type_spouse' => 'echtgenoot',
    'relationship_type_spouse_female' => 'echtgenoot',
    'relationship_type_spouse_with_name' => ': naam van echtgeno(o)t(e)',
    'relationship_type_spouse_female_with_name' => ': naam van echtgeno(o)t(e)',
    ...
    'relationship_type_lover_with_name' => ':naam\'s geliefde',
    'relationship_type_lover_female_with_name' => ':naam\'s geliefde',
    ...
    'relationship_type_ex_with_name' => ':naam\'s ex-vriendje',
    'relationship_type_ex_female_with_name' => ':naam\'s ex-vriendinnetje',

    'relationship_type_parent' => 'vader',
    'relationship_type_parent_female' => 'moeder',
    'relationship_type_parent_with_name' => ':naam\'s vader',
    'relationship_type_parent_female_with_name' => ':naam\'s moeder',

    'relationship_type_child' => 'zoon',
    'relationship_type_child_female' => 'dochter',
    'relationship_type_child_with_name' => ':naam\'s zoon',
    'relationship_type_child_female_with_name' => ':naam\'s dochter',

    'relationship_type_sibling' => 'broer',
    'relationship_type_sibling_female' => 'zus',
    'relationship_type_sibling_with_name' => ':naam\'s broer',
    'relationship_type_sibling_female_with_name' => ':naam\'s zus',

    'relationship_type_grandparent' => 'grootouder',
    'relationship_type_grandparent_female' => 'grootouder',
    'relationship_type_grandparent_with_name' => ':naam\'s grootouder',
    'relationship_type_grandparent_female_with_name' => ':naam\'s grootouder',

    'relationship_type_grandchild' => 'kleinkind',
    'relationship_type_grandchild_female' => 'kleinkind',
    'relationship_type_grandchild_with_name' => ':naam\'s kleinkind',
    'relationship_type_grandchild_female_with_name' => ':naam\'s kleinkind',

    'relationship_type_uncle' => 'oom',
    'relationship_type_uncle_female' => 'tante',
    'relationship_type_uncle_with_name' => ':naam\'s oom',
    'relationship_type_uncle_female_with_name' => ':naam\'s tante',

    'relationship_type_nephew' => 'neef',
    'relationship_type_nephew_female' => 'nicht',
    'relationship_type_nephew_with_name' => ':naam\'s neef',
    'relationship_type_nephew_female_with_name' => ':naam\'s nicht',

    'relationship_type_cousin' => 'neef',
    'relationship_type_cousin_female' => 'neef',
    'relationship_type_cousin_with_name' => ':naam\'s neef',
    'relationship_type_cousin_female_with_name' => ':naam\'s neef',
    ...
    'relationship_type_friend_with_name' => ':naam\'s vriend',
    'relationship_type_friend_female_with_name' => ':naam\'s vriend',

    'relationship_type_bestfriend' => 'beste Vriend',
    'relationship_type_bestfriend_female' => 'beste Vriend',
    'relationship_type_bestfriend_with_name' => ':naam\'s beste vriend',
    'relationship_type_bestfriend_female_with_name' => ':naam\'s beste vriend',

    'relationship_type_colleague' => 'collega',
    'relationship_type_colleague_female' => 'collega',
    'relationship_type_colleague_with_name' => ':naam\'s collega',
    'relationship_type_colleague_female_with_name' => ':naam\'s collega',
