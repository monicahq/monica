...
return [
    ...
    'people_list_stats' => '1 контакт|:count контактів',
    ...
    'people_list_lastactivitydateNewtoOld' => 'Сортувати за датою останньої активності за найстарішими',
    ...
    'people_add_missing' => 'Людину не знайдено Додати нову зараз',
    ...
    'people_delete_confirmation' => 'Ви дійсно хочете видалити цей контакт? Видалення є незворотнім.',
    ...
    // age - birthday
    'birthdate_not_set' => 'Дата народження не встановлено',
    ...
    'information_edit_lastname' => 'Прізвище (необов\'язково)',
    'information_edit_description' => 'Опис (необов\'язково)',
    ...
    'information_edit_exact' => 'Я знаю точну дату народження цієї людини...',
    'information_edit_birthdate_label' => 'Дата народження',
