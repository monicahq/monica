...
class Account extends Model
{
     ...
     * @return $this
     */
    public static function createDefault($first_name, $last_name, $email, $password, $ipAddress = null, $country = null, $lang = null)
    {
        // create new account
        $account = new self;
        ...
        User::createDefault($account->id, $first_name, $last_name, $email, $password, $ipAddress, $country, $lang);
