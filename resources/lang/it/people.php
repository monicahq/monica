...
return [
    ...
    'people_list_number_kids' => ':count child|:conta figli',
    'people_list_last_updated' => 'Ultimo contatto:',
    'people_list_number_reminders' => ':count reminder|:conta promemoria',
    ...
    'people_list_stats' => ':count contact|:conta contatti',
    ...
    'people_list_lastactivitydateNewtoOld' => 'Ordina per data di ultima attività, da più recente a meno recente',
    'people_list_lastactivitydateOldtoNew' => 'Ordina per data di ultima attività, dalla meno recente alla più recente',
    'people_list_filter_tag' => 'Tutti i contatti etichettati con',
    'people_list_clear_filter' => 'Rimuovi filtro',
    'people_list_contacts_per_tags' => ':count contact|:conta contatti',
    'people_list_show_dead' => 'Mostra persone decedute (:count)',
    'people_list_hide_dead' => 'Nascondi persone decedute (:count)',
    'people_search' => 'Cerca i tuoi contatti…',
    ...
    'people_delete_confirmation' => 'Sei sicuro di voler eliminare il contatto di :name? L\'eliminazione è immediata e permanente.',
    ...
    'people_add_reminder_for_birthday' => 'Crea un promemoria annuale del compleanno',
    ...
    'contact_archive_help' => 'I contatti archiviati non sono mostrati sull\'elenco di contatti, ma appaiono comunque nei risultati della ricerca.',
    ...
    'stay_in_touch_modal_label' => 'Inviami un\'email ogni… {count} giorno| Inviami un\'email ogni… {count} giorni',
    ...
    // Conversation
    'conversation_blank' => 'Registra le conversazioni che hai con :name sui social, SMS…',
    ...
    'conversation_add_who_wrote' => 'Chi ha inviato questo messaggio?',
    ...
    // age - birthday
    'birthdate_not_set' => 'Il compleanno non è impostato',
    ...
    'information_edit_description' => 'Descrizione (facoltativa)',
    ...
    'information_edit_probably' => 'Questa persona è probabilmente…',
    'information_edit_not_year' => 'Conosco il giorno e il mese del compleanno di questa persona, ma non l\'anno…',
    'information_edit_exact' => 'Conosco il compleanno esatto di questa persona…',
    'information_edit_birthdate_label' => 'Compleanno',
    ...
    'work_edit_success' => 'Informazioni lavorative aggiornate',
    ...
    'reminders_description' => 'Invieremo un\'email per ognuno dei seguenti promemoria. I promemoria sono inviati ogni mattina in cui si verificherà l\'evento. I promemoria aggiunti automaticamente per i compleanno non sono eliminabili. Se vuoi modificare queste date, modifica il compleanno dei contatti.',
    ...
    'relationship_form_is_with_name' => ':name è…',
    ...
    'activities_add_pick_activity' => 'Vorresti categorizzare quest\'attività? Non devi, ma ti darà le statistiche in seguito (facoltativo)',
    'activities_add_date_occured' => 'L\'attività è avvenuta il…',
    ...
    'activities_list_participants' => 'Partecipanti ({total}):',
    ...
    'life_event_create_date' => 'Non devi indicare un giorno o un mese, solo l\'anno è obbligatorio.',
    ...
    'document_upload_zone_progress' => 'Caricando il documento…',
