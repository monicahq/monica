...
Route::get('/invitations/accept/{key}', 'SettingsController@acceptInvitation')->name('invitations.accept');
Route::post('/invitations/accept/{key}', 'SettingsController@storeAcceptedInvitation')->name('invitations.send');
