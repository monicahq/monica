...
return [
    ...
    'people_add_email' => 'E-mail (προαιρετικό)',
    ...
    'people_add_birthday_reminder_deceased' => 'Την ημερομηνία αυτή, η επαφή :name, θα είχε γιορτάσει τα γενέθλιά τους',
    ...
    'information_edit_lastname' => 'Επώνυμο (Προαιρετικό)',
    'information_edit_description' => 'Περιγραφή (Προαιρετικό)',
    ...
    'activities_add_pick_activity' => '(Προαιρετικό) Θα θέλατε να κατηγοριοποιήσετε αυτή τη δραστηριότητα; Δεν είναι απαραίτητο, αλλά θα σας δώσει στατιστικά στοιχεία αργότερα',
