...
class ApiRelationshipControllerTest extends ApiTestCase
{
    ...
    {
        $user = $this->signin();
        $contactA = factory('App\Models\Contact\Contact')->create([
            'account_id' => $user->account_id,
        ]);
        $contactB = factory('App\Models\Contact\Contact')->create([
            'account_id' => $user->account_id,
        ]);
    ...
    {
        $user = $this->signin();
        $contactA = factory('App\Models\Contact\Contact')->create(['account_id' => $user->account->id]);
        $contactB = factory('App\Models\Contact\Contact')->create(['account_id' => $user->account->id]);
        ...
        $relationshipTypeB = factory('App\Models\Relationship\RelationshipType')->create([
            'account_id' => $user->account->id,
            'name' => 'nephew',
    ...
    public function test_it_deletes_a_relationship()
    {
        ...
        $relationshipB = factory('App\Models\Relationship\Relationship')->create([
            'account_id' => $user->account->id,
    ...
    public function test_it_updates_a_relationship()
    {
        ...
        $relationshipTypeC = factory('App\Models\Relationship\RelationshipType')->create([
            'account_id' => $user->account->id,
            'name' => 'fuckfriend',
    ...
    public function test_it_displays_all_relationships_of_a_contact()
    {
        ...
        $relationship = factory('App\Models\Relationship\Relationship', 3)->create([
            'account_id' => $user->account->id,
            'relationship_type_id' => $relationshipType->id,
            'contact_is' => $contactA->id,
            'of_contact' => $contactB->id,
