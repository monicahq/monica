...
$factory->define(App\Models\Contact\Activity::class, function (Faker\Generator $faker) {
    return [
        ...
        'date_it_happened' => \App\Helpers\DateHelper::parseDateTime($faker->dateTimeThisCentury()->getTimeStamp()),
    ];
});
...
$factory->define(App\Models\Contact\Gift::class, function (Faker\Generator $faker) {
    ...
    return [
        'account_id' => $contact->account_id,
        'contact_id' => $contact->id,
        'created_at' => \App\Helpers\DateHelper::parseDateTime($faker->dateTimeThisCentury()->getTimeStamp()),
    ];
});
...
$factory->define(App\Models\Instance\SpecialDate::class, function (Faker\Generator $faker) {
    ...
    return [
        'account_id' => $contact->account_id,
        'contact_id' => $contact->id,
        'date' => \App\Helpers\DateHelper::parseDateTime($faker->dateTimeThisCentury()->getTimeStamp()),
        'created_at' => \App\Helpers\DateHelper::parseDateTime($faker->dateTimeThisCentury()->getTimeStamp()),
    ];
});
