...
return [
    ...
    'sidebar_settings_tags' => 'Gerenciamento de etiquetas',
    'sidebar_settings_api' => 'API',
    'sidebar_settings_dav' => 'DAV Resources',
    'sidebar_settings_security' => 'Segurança',

    'export_title' => 'Exporte os dados da sua conta',
    'export_be_patient' => 'Clique no botão para iniciar a exportação. Pode levar vários minutos para processar a exportação – por favor, seja paciente e não pressione o botão várias vezes.',
    ...
    'export_sql_link_instructions' => 'Observação: <a href=":url">leia as instruções</a> para saber mais sobre como importar o arquivo gerado para sua instância.',
    ...
    'email_help' => 'Este é o e-mail usado para logar, e é aqui que você receberá os seus lembretes.',
    ...
    'delete_desc' => 'Você deseja excluir sua conta? Aviso: a exclusão é permanente e todos os seus dados serão apagados permanentemente.',
    ...
    'reset_notice' => 'Quer mesmo redefinir sua conta? Você não poderá voltar atrás.',
    'reset_success' => 'Sua conta foi redefinida com sucesso',
    'delete_notice' => 'Quer mesmo excluir sua conta? Você não poderá voltar atrás.',
    ...
    'password_new1_placeholder' => 'Digite a nova senha',
    'password_new2' => 'Confirmação',
    'password_new2_placeholder' => 'Repita a nova senha',
