...
return [
    ...
    'export_sql_explanation' => 'Exportar tus datos en formato SQL allows you to take your data and import it to your own Monica instance. This is only valuable if you do have your own server.',
    'export_sql_cta' => 'Exportar a SQL',
    'export_sql_link_instructions' => 'Nota: <a href=":url">read the instructions</a> to learn more about importing this file to your instance.',

    'name_order' => 'Name order',
    'name_order_firstname_first' => 'Nombre primero (John Doe)',
    'name_order_lastname_first' => 'Apellido primero (Doe John)',
    'currency' => 'Moneda',
    'name' => 'Tu nombre: :name',
    'email' => 'Email',
    ...
    'users_list_invitations_sent_date' => 'enviado el :date',
