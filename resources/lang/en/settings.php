...
return [
    ...
    'settings.personalization_life_event_category_work_education' => 'Work & education',
    'settings.personalization_life_event_category_family_relationships' => 'Family & relationships',
    'settings.personalization_life_event_category_home_living' => 'Home & living',
    'settings.personalization_life_event_category_travel_experiences' => 'Travel & experiences',
    'settings.personalization_life_event_category_health_wellness' => 'Health & wellness',

    'settings.personalization_life_event_type_new_job' => 'New job',
    'settings.personalization_life_event_type_retirement' => 'Retirement',
    'settings.personalization_life_event_type_new_school' => 'New school',
    'settings.personalization_life_event_type_study_abroad' => 'Study abroad',
    'settings.personalization_life_event_type_volunteer_work' => 'Volunteer work',
    'settings.personalization_life_event_type_published_book_or_paper' => 'Published a book or paper',
    'settings.personalization_life_event_type_military_service' => 'Military service',
    'settings.personalization_life_event_type_first_met' => 'First met',
    'settings.personalization_life_event_type_new_relationship' => 'New relationship',
    'settings.personalization_life_event_type_engagement' => 'Engagement',
    'settings.personalization_life_event_type_marriage' => 'Marriage',
    'settings.personalization_life_event_type_anniversary' => 'Anniversary',
    'settings.personalization_life_event_type_expecting_a_baby' => 'Expecting a baby',
    'settings.personalization_life_event_type_new_child' => 'New child',
    'settings.personalization_life_event_type_new_family_member' => 'New family member',
    'settings.personalization_life_event_type_new_pet' => 'New pet',
    'settings.personalization_life_event_type_end_of_relationship' => 'End of relationship',
    'settings.personalization_life_event_type_loss_of_a_loved_one' => 'Loss of a loved one',
    'settings.personalization_life_event_type_moved' => 'Moved',
    'settings.personalization_life_event_type_bought_a_home' => 'Bought a home',
    'settings.personalization_life_event_type_home_improvement' => 'Home improvement',
    'settings.personalization_life_event_type_holidays' => 'Holidays',
    'settings.personalization_life_event_type_new_vehicule' => 'New vehicule',
    'settings.personalization_life_event_type_new_roommate' => 'New roommate',
    'settings.personalization_life_event_type_organ_donor' => 'Organ donor',
    'settings.personalization_life_event_type_overcame_an_illness' => 'Overcame an illness',
    'settings.personalization_life_event_type_quit_a_habit' => 'Quit a habit',
    'settings.personalization_life_event_type_new_eating_habits' => 'New eating habits',
    'settings.personalization_life_event_type_weight_loss' => 'Weight loss',
    'settings.personalization_life_event_type_wear_glass_or_contact' => 'Wear glass or contact',
    'settings.personalization_life_event_type_broken_bone' => 'Broken bone',
    'settings.personalization_life_event_type_removed_braces' => 'Removed braces',
    'settings.personalization_life_event_type_surgery' => 'Surgery',
    'settings.personalization_life_event_type_dentist' => 'Dentist',
    'settings.personalization_life_event_type_new_sport' => 'New sport',
    'settings.personalization_life_event_type_new_hobby' => 'New hobby',
    'settings.personalization_life_event_type_new_instrument' => 'New instrument',
    'settings.personalization_life_event_type_new_language' => 'New language',
    'settings.personalization_life_event_type_tatoo_or_piercing' => 'Tatoo or piercing',
    'settings.personalization_life_event_type_new_license' => 'New license',
    'settings.personalization_life_event_type_travel' => 'Travel',
    'settings.personalization_life_event_type_achievement_or_award' => 'Achievement or award',
    'settings.personalization_life_event_type_changed_beliefs' => 'Changed beliefs',
    'settings.personalization_life_event_type_first_word' => 'First word',
    'settings.personalization_life_event_type_first_kiss' => 'First kiss',
];
