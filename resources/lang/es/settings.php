...
return [
    ...
    'export_be_patient' => 'Haz clic en el botón para comenzar la exportación. El proceso puede tardar varios minutos. Sé paciente, no repitas el clic sobre el botón.',
    'export_title_sql' => 'Exportar datos en formato SQL',
    'export_sql_explanation' => 'Exportar en formato SQL te permite mover tu información e importarla en otra instancia de Monica. Es útil si ejecutas tu propia instancia de Monica.',
    'export_sql_cta' => 'Exportar datos en formato SQL',
    'export_sql_link_instructions' => '<a href=":url">Lee las instrucciones</a> para entender cómo importar este fichero en tu instancia.',
    ...
    'name_order_nickname_firstname_lastname' => '<Apodo> (<Apellido> <Nombre>) – El Nota (Pérez Juan)',
