...
return [
    ...
    'export_be_patient' => 'Κάντε κλικ στο κουμπί για να ξεκινήσετε την εξαγωγή. Μπορεί να χρειαστούν μερικά λεπτά για την επεξεργασία της εξαγωγής – παρακαλώ να είστε υπομονετικοί και μην κάνετε επανειλημμένα κλικ στο κουμπί.',
    'export_title_sql' => 'Εξαγωγή δεδομένων σε SQL',
    'export_sql_explanation' => 'Η εξαγωγή των δεδομένων σας σε μορφή SQL σας επιτρέπει να πάρετε τα δεδομένα σας και να τα εισαγάγετε στη δική σας παρουσία Monica. Αυτό είναι χρήσιμο μόνο αν τρέχετε Monica στο δικό σας διακομιστή.',
    'export_sql_cta' => 'Εξαγωγή δεδομένων σε SQL',
    'export_sql_link_instructions' => '<a href=":url">Διαβάστε τις οδηγίες</a> για να μάθετε πώς να εισάγετε αυτό το αρχείο στην εγκατάστασή σας.',
    ...
    'temperature_scale_fahrenheit' => 'Φαρενάιτ',
    'temperature_scale_celsius' => 'Κελσίου',
    'layout' => 'Διάταξη',
    ...
    'delete_other_desc' => 'Τα δεδομένα σας στην κύρια βάση δεδομένων θα διαγραφούν αμέσως. Όπως περιγράφεται στην πολιτική απορρήτου μας, πραγματοποιούμε καθημερινά αντίγραφα ασφαλείας, ασφαλώς κρυπτογραφημένα αντίγραφα ασφαλείας της βάσης δεδομένων και αυτό το αντίγραφο ασφαλείας διατηρείται για 30 ημέρες μετά τις οποίες διαγράφεται πλήρως. Δεν μπορούμε να διαγράψουμε συγκεκριμένα δεδομένα από τα αντίγραφα ασφαλείας που διατηρούμε πριν από αυτό. Όλα τα δεδομένα σας θα διαγραφούν πλήρως εντός 30 ημερών από τη διαγραφή του λογαριασμού σας.',
