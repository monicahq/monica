...
return [
    ...
    'relationship_type_partner_male' => 'nửa kia',
    ...
    'relationship_type_inlovewith_male_with_name' => ':name có tình cảm với',

    'relationship_type_lovedby' => 'được thích bởi',
    'relationship_type_lovedby_female' => 'được thích bởi',
    'relationship_type_lovedby_male' => 'được yêu bởi',
    ...
    'relationship_type_lovedby_male_with_name' => 'người tình bí mật của :name',

    'relationship_type_ex' => 'người yêu cũ',
    'relationship_type_ex_female' => 'người yêu cũ',
    'relationship_type_ex_male' => 'bạn trai cũ',
    'relationship_type_ex_with_name' => 'người yêu cũ của :name',
    'relationship_type_ex_female_with_name' => 'người yêu cũ của :name',
    'relationship_type_ex_male_with_name' => 'bạn trai cũ của :name',

    'relationship_type_parent' => 'bố mẹ',
    'relationship_type_parent_female' => 'mẹ',
    'relationship_type_parent_male' => 'bố',
    'relationship_type_parent_with_name' => 'bố mẹ của :name',
    'relationship_type_parent_female_with_name' => 'mẹ của :name',
    'relationship_type_parent_male_with_name' => 'bố của :name',

    'relationship_type_child' => 'con',
    'relationship_type_child_female' => 'con gái',
    'relationship_type_child_male' => 'con trai',
    'relationship_type_child_with_name' => 'con của :name',
    'relationship_type_child_female_with_name' => 'con gái của :name',
    'relationship_type_child_male_with_name' => 'con trai của :name',

    'relationship_type_stepparent' => 'bố mẹ hai',
    'relationship_type_stepparent_female' => 'mẹ kế',
    'relationship_type_stepparent_male' => 'bố dượng',
    'relationship_type_stepparent_with_name' => 'bố mẹ hai của :name',
    'relationship_type_stepparent_female_with_name' => 'mẹ kế của :name',
    'relationship_type_stepparent_male_with_name' => 'bố dượng của :name',

    'relationship_type_stepchild' => 'con riêng',
    'relationship_type_stepchild_female' => 'con gái riêng',
    'relationship_type_stepchild_male' => 'con trai riêng',
    'relationship_type_stepchild_with_name' => 'con riêng của :name',
    'relationship_type_stepchild_female_with_name' => 'con gái riêng của :name',
    'relationship_type_stepchild_male_with_name' => 'con trai riêng của :name',

    'relationship_type_sibling' => 'anh chị em ruột',
    'relationship_type_sibling_female' => 'Chị em gái',
    'relationship_type_sibling_male' => 'anh em trai',
    'relationship_type_sibling_with_name' => 'anh chị em ruột của :name',
    'relationship_type_sibling_female_with_name' => 'chị gái của :name',
    'relationship_type_sibling_male_with_name' => 'anh trai của :name',

    'relationship_type_grandparent' => 'ông bà',
    'relationship_type_grandparent_female' => 'bà',
    'relationship_type_grandparent_male' => 'ông',
    'relationship_type_grandparent_with_name' => 'ông bà của :name',
    'relationship_type_grandparent_female_with_name' => 'bà của :name',
    'relationship_type_grandparent_male_with_name' => 'ông của :name',

    'relationship_type_grandchild' => 'cháu',
    'relationship_type_grandchild_female' => 'cháu gái',
    'relationship_type_grandchild_male' => 'cháu trai',
    'relationship_type_grandchild_with_name' => 'cháu của :name',
    'relationship_type_grandchild_female_with_name' => 'cháu gái của :name',
    'relationship_type_grandchild_male_with_name' => 'cháu trai của :name',

    'relationship_type_uncle' => 'chú/bác',
    'relationship_type_uncle_female' => 'cô/dì',
    'relationship_type_uncle_male' => 'chú',
    'relationship_type_uncle_with_name' => 'chú/bác của :name',
    'relationship_type_uncle_female_with_name' => 'cô/dì của :name',
    'relationship_type_uncle_male_with_name' => 'chú của :name',

    'relationship_type_nephew' => 'cháu trai',
    'relationship_type_nephew_female' => 'cháu gái',
    'relationship_type_nephew_male' => 'cháu trai',
    'relationship_type_nephew_with_name' => 'cháu trai của :name',
    'relationship_type_nephew_female_with_name' => 'cháu gái của :name',
    'relationship_type_nephew_male_with_name' => 'cháu trai của :name',

    'relationship_type_cousin' => 'anh em họ',
    'relationship_type_cousin_female' => 'anh em họ',
    'relationship_type_cousin_male' => 'anh em họ',
    'relationship_type_cousin_with_name' => 'anh em họ của :name',
    'relationship_type_cousin_female_with_name' => 'anh em họ của :name',
    'relationship_type_cousin_male_with_name' => 'anh em họ của :name',

    'relationship_type_godfather' => 'bố mẹ đỡ đầu',
    'relationship_type_godfather_female' => 'mẹ đỡ đầu',
    'relationship_type_godfather_male' => 'bố đỡ đầu',
    'relationship_type_godfather_with_name' => 'bố mẹ đỡ đầu của :name',
    'relationship_type_godfather_female_with_name' => 'mẹ đỡ đầu của :name',
    'relationship_type_godfather_male_with_name' => 'bố đỡ đầu của :name',

    'relationship_type_godson' => 'con đỡ đầu',
    'relationship_type_godson_female' => 'con gái đỡ đầu',
    'relationship_type_godson_male' => 'con trai đỡ đầu',
    'relationship_type_godson_with_name' => 'cháu đỡ đầu của :name',
    'relationship_type_godson_female_with_name' => 'con gái đỡ đầu của :name',
    'relationship_type_godson_male_with_name' => 'con trai đỡ đầu của :name',

    'relationship_type_friend' => 'bạn bè',
    'relationship_type_friend_female' => 'bạn bè',
    'relationship_type_friend_male' => 'bạn bè',
    'relationship_type_friend_with_name' => 'bạn của :name',
    'relationship_type_friend_female_with_name' => 'bạn của :name',
    'relationship_type_friend_male_with_name' => 'bạn của :name',

    'relationship_type_bestfriend' => 'bạn thân',
    'relationship_type_bestfriend_female' => 'bạn thân',
    'relationship_type_bestfriend_male' => 'bạn thân',
    'relationship_type_bestfriend_with_name' => 'bạn thân của :name',
    'relationship_type_bestfriend_female_with_name' => 'bạn thân của :name',
    'relationship_type_bestfriend_male_with_name' => 'bạn thân của :name',
    ...
    'relationship_type_subordinate_male_with_name' => 'cấp dưới của :name',

    'relationship_type_mentor' => 'người hướng dẫn',
    'relationship_type_mentor_female' => 'người hướng dẫn',
    'relationship_type_mentor_male' => 'người hướng dẫn',
    ...
    'relationship_type_mentor_male_with_name' => 'người hướng dẫn của :name',

    'relationship_type_protege' => 'người được bảo hộ',
    'relationship_type_protege_female' => 'người được bảo hộ',
    'relationship_type_protege_male' => 'người được bảo hộ',
    ...
    'relationship_type_protege_male_with_name' => 'người được :name bảo hộ',

    'relationship_type_ex_husband' => 'vợ cũ',
    'relationship_type_ex_husband_female' => 'vợ cũ',
    'relationship_type_ex_husband_male' => 'chồng cũ',
    'relationship_type_ex_husband_with_name' => 'vợ cũ của :name',
    'relationship_type_ex_husband_female_with_name' => 'vợ cũ của :name',
    'relationship_type_ex_husband_male_with_name' => 'chồng cũ của :name',
    ...
    'emotion_delight' => 'Thỏa thích',
    'emotion_enjoyment' => 'Hưởng thụ',
    'emotion_gladness' => 'Vui mừng',
    'emotion_happiness' => 'Hạnh phúc',
    'emotion_jubilation' => 'Hân hoan',
    'emotion_elation' => 'Phấn khởi',
    'emotion_satisfaction' => 'Mức độ thỏa mãn',
    'emotion_ecstasy' => 'Ngây ngất',
    'emotion_euphoria' => 'Hưng Phấn',
    'emotion_enthusiasm' => 'Hăng hái',
    'emotion_zeal' => 'Sốt sắng',
    'emotion_zest' => 'Hăng hái',
    'emotion_excitement' => 'Hứng thú',
    'emotion_thrill' => 'Sợ hãi',
    'emotion_exhilaration' => 'Phấn khởi',
    'emotion_contentment' => 'Hài lòng',
    'emotion_pleasure' => 'Thích thú',
    'emotion_pride' => 'Tự hào',
    'emotion_eagerness' => 'Háo hức',
    'emotion_hope' => 'Hy vọng',
    'emotion_optimism' => 'Lạc quan',
    'emotion_enthrallment' => 'Say mê',
    'emotion_rapture' => 'Sung sướng',
    'emotion_relief' => 'Cứu trợ',
    'emotion_amazement' => 'Ngạc nhiên',
    'emotion_surprise' => 'Bất ngờ',
    'emotion_astonishment' => 'Kinh ngạc',
    'emotion_aggravation' => 'Trầm trọng',
    'emotion_irritation' => 'Kích thích',
    'emotion_agitation' => 'Kích động',
    'emotion_annoyance' => 'Phiền toái',
    'emotion_grouchiness' => 'Cáu kỉnh',
    'emotion_grumpiness' => 'Gắt gỏng',
    'emotion_exasperation' => 'Bực tức',
    'emotion_frustration' => 'Kém',
    'emotion_anger' => 'Tức giận',
    'emotion_rage' => 'Thịnh nộ',
    'emotion_outrage' => 'Phẫn Nộ',
    'emotion_fury' => 'Cuồng nộ',
    'emotion_wrath' => 'Thịnh nộ',
    'emotion_hostility' => 'Thù địch',
    'emotion_ferocity' => 'Hung dữ',
    'emotion_bitterness' => 'Thù oán',
    'emotion_hate' => 'Ghét',
    'emotion_loathing' => 'Ghê tởm',
    'emotion_scorn' => 'Khinh bỉ',
    'emotion_spite' => 'Thù hằn',
    'emotion_vengefulness' => 'Báo thù',
    'emotion_dislike' => 'Không thích',
    'emotion_resentment' => 'Phẫn nộ',
    'emotion_disgust' => 'Chán ghét',
    'emotion_revulsion' => 'Nổi loạn',
    'emotion_contempt' => 'Khinh thường',
    'emotion_envy' => 'Đố kị',
    'emotion_jealousy' => 'Ghen tị',
    'emotion_agony' => 'Đau đớn',
    'emotion_suffering' => 'Đau khổ',
    'emotion_hurt' => 'Tổn thương',
    'emotion_anguish' => 'Đau khổ',
    'emotion_depression' => 'Trầm cảm',
    'emotion_despair' => 'Tuyệt vọng',
    'emotion_hopelessness' => 'Vô vọng',
    'emotion_gloom' => 'U ám',
    'emotion_glumness' => 'Ủ rũ',
    'emotion_sadness' => 'Buồn bã',
    'emotion_unhappiness' => 'Bất hạnh',
    'emotion_grief' => 'Thất bại',
    'emotion_sorrow' => 'Phiền muộn',
    'emotion_woe' => 'Khốn đốn',
    'emotion_misery' => 'Nghèo khổ',
    'emotion_melancholy' => 'U sầu',
    'emotion_dismay' => 'Mất tinh thần',
    'emotion_disappointment' => 'Thất vọng',
    'emotion_displeasure' => 'Bất mãn',
    'emotion_guilt' => 'Tội lỗi',
    'emotion_shame' => 'Xấu hổ',
    'emotion_regret' => 'Hối tiếc',
    'emotion_remorse' => 'Ăn năn',
    'emotion_alienation' => 'Xa lánh',
    'emotion_isolation' => 'Cách ly',
    'emotion_neglect' => 'Bỏ bê',
    'emotion_loneliness' => 'Cô đơn',
    'emotion_rejection' => 'Chối bỏ',
    'emotion_homesickness' => 'Nhớ nhà',
    'emotion_defeat' => 'Thất bại',
    'emotion_dejection' => 'Chán nản',
    'emotion_insecurity' => 'Không an toàn',
    'emotion_embarrassment' => 'Xấu hổ',
    'emotion_humiliation' => 'Làm nhục',
    'emotion_insult' => 'Xúc phạm',
    'emotion_pity' => 'Đảm Bảo',
    'emotion_sympathy' => 'Cảm thông',
    'emotion_alarm' => 'Báo động',
    'emotion_shock' => 'Bị sốc',
    'emotion_fear' => 'Sợ hãi',
    'emotion_fright' => 'Sợ hãi',
    'emotion_horror' => 'Ghê rợn',
    'emotion_terror' => 'Khủng bố',
    'emotion_panic' => 'Hoảng sợ',
    'emotion_hysteria' => 'Cuồng loạn',
    'emotion_mortification' => 'Hành xác',
    'emotion_anxiety' => 'Lo lắng',
    'emotion_nervousness' => 'Lo lắng',
    'emotion_tenseness' => 'Căng thẳng',
    'emotion_uneasiness' => 'Khó chịu',
    'emotion_apprehension' => 'E ngại',
    'emotion_worry' => 'Lo lắng',
    'emotion_distress' => 'Tai hoạ',
    'emotion_dread' => 'Kinh sợ',
    ...
    'weather_patchy-light-drizzle' => 'Mưa phùn',
    'weather_patchy-light-rain' => 'Mưa nhẹ',
    'weather_light-rain' => 'Mưa nhỏ',
    'weather_moderate-rain-at-times' => 'Mưa vừa vừa',
    'weather_moderate-rain' => 'Mưa vừa',
    'weather_patchy-rain-possible' => 'Mưa hơi lớn',
    'weather_heavy-rain-at-times' => 'Mưa khá lớn',
    'weather_heavy-rain' => 'Mưa to',
    'weather_light-freezing-rain' => 'Mưa lành lạnh',
    'weather_moderate-or-heavy-freezing-rain' => 'Mưa nặng hạt',
    'weather_light-sleet' => 'Tuyết nhỏ',
    'weather_moderate-or-heavy-rain-shower' => 'Mưa vừa hoặc mưa to',
    'weather_light-rain-shower' => 'Mưa rào nhỏ',
    'weather_torrential-rain-shower' => 'Mưa rào xối xả',
    'weather_rain' => 'Mưa',
    'weather_snow' => 'Tuyết',
    'weather_blowing-snow' => 'Tuyết dày đặc',
    'weather_patchy-light-snow' => 'Mưa nhẹ',
    'weather_light-snow' => 'Tuyết rơi nhẹ',
    'weather_patchy-moderate-snow' => 'Tuyêt rơi vừa phải',
    'weather_moderate-snow' => 'Tuyết rơi vừa',
    'weather_patchy-heavy-snow' => 'Tuyết khá dày',
    'weather_heavy-snow' => 'Tuyết dày đặc',
    'weather_light-snow-showers' => 'Mưa tuyết nhẹ',
    'weather_moderate-or-heavy-snow-showers' => 'Tuyết vừa hoặc tuyết to',
    'weather_patchy-snow-possible' => 'Tuyết hơi lớn',
    'weather_patchy-sleet-possible' => 'Tuyết khá lớn',
    'weather_moderate-or-heavy-sleet' => 'Mưa tuyết dày đến rất dày',
    'weather_light-sleet-showers' => 'Mưa rào',
    'weather_moderate-or-heavy-sleet-showers' => 'Mưa tuyết vừa hoặc to',
    'weather_sleet' => 'Mưa tuyết',
    'weather_wind' => 'Gió',
    'weather_fog' => 'Sương mù',
    'weather_freezing-fog' => 'Sương mù đóng băng',
    'weather_mist' => 'Sương mù',
    'weather_blizzard' => 'Bão tuyết',
    'weather_overcast' => 'Trời u ám',
    'weather_cloudy' => 'Nhiều mây',
    'weather_partly-cloudy-day' => 'Mây rải rác',
    'weather_partly-cloudy-night' => 'Mây rải rác',
    'weather_freezing-drizzle' => 'Mưa phùn đông đá',
    'weather_heavy-freezing-drizzle' => 'Mưa phùn nặng hạt',
    'weather_patchy-freezing-drizzle-possible' => 'Mưa phùn lạnh cóng',
    'weather_ice-pellets' => 'Mưa đá',
    'weather_light-showers-of-ice-pellets' => 'Những cơn mưa đá nhỏ',
    'weather_moderate-or-heavy-showers-of-ice-pellets' => 'Mưa đá to đến nặng hạt',
    'weather_thundery-outbreaks-possible' => 'Có khả năng có sấm sét',
    'weather_patchy-light-rain-with-thunder' => 'Mưa rải rác và có sấm',
    'weather_moderate-or-heavy-rain-with-thunder' => 'Mưa rơi nhiều kèm giông sấm sét',
    'weather_patchy-light-snow-with-thunder' => 'Tuyết rơi nhẹ với sấm sét',
    'weather_moderate-or-heavy-snow-with-thunder' => 'Tuyết rơi dày kèm giông sấm sét',
    ...
    'dav_birthdays_description' => 'Sinh nhật của liên hệ :name',
    'dav_tasks' => 'Nhiệm vụ',
