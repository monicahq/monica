...
return [
    ...
    'relationship_type_lovedby_female' => 'נאהב על ידי',
    'relationship_type_lovedby_reverse' => 'מאוהב',
    'relationship_type_lovedby_reverse_female' => 'מאוהב',
    ...
    'relationship_type_sibling_reverse_with_name' => 'אח של :name',
    'relationship_type_sibling_reverse_female_with_name' => 'אחות של :name',
    ...
    'relationship_type_grandparent_reverse_with_name' => 'נכד של :name',
    'relationship_type_grandparent_reverse_female_with_name' => 'נכדה של :name',

    'relationship_type_grandchild' => 'נכד',
    'relationship_type_grandchild_female' => 'נכדה',
    'relationship_type_grandchild_reverse' => 'סבא',
    ...
    'relationship_type_grandchild_reverse_with_name' => 'סבא של :name',
    'relationship_type_grandchild_reverse_female_with_name' => 'סבתא של :name',
    ...
    'relationship_type_nephew_reverse' => 'דוד',
    'relationship_type_nephew_reverse_female' => 'דודה',
    ...
    'relationship_type_cousin_female' => 'בן דוד',
    'relationship_type_cousin_reverse' => 'בן דוד',
    'relationship_type_cousin_reverse_female' => 'בן דוד',
    'relationship_type_cousin_with_name' => 'בן דוד של :name',
    'relationship_type_cousin_female_with_name' => 'בן דוד של :name',
    'relationship_type_cousin_reverse_with_name' => 'בן דוד של :name',
    'relationship_type_cousin_reverse_female_with_name' => 'בן דוד של :name',
    ...
    'relationship_type_godfather_reverse_with_name' => 'בן הסנדקות של :name',
    'relationship_type_godfather_reverse_female_with_name' => 'בת הסנדקות של :name',

    'relationship_type_godson' => 'בן סנדקות',
    'relationship_type_godson_female' => 'בת סנדקות',
    'relationship_type_godson_reverse' => 'סנדק',
    'relationship_type_godson_reverse_female' => 'סנדקית',
    'relationship_type_godson_with_name' => 'הסנדק של :name',
    'relationship_type_godson_female_with_name' => 'בת הסנדקות של :name',
    'relationship_type_godson_reverse_with_name' => 'הסנדק של :name',
    'relationship_type_godson_reverse_female_with_name' => 'הסנדקית של :name',
    ...
    'relationship_type_colleague_female' => 'עמית לעבודה',
    'relationship_type_colleague_reverse' => 'עמית לעבודה',
    'relationship_type_colleague_reverse_female' => 'עמית לעבודה',
    'relationship_type_colleague_with_name' => 'עמית לעבודה של :name',
    'relationship_type_colleague_female_with_name' => 'עמית לעבודה של :name',
    'relationship_type_colleague_reverse_with_name' => 'עמית לעבודה של :name',
    'relationship_type_colleague_reverse_female_with_name' => 'עמית לעבודה של :name',

    'relationship_type_boss' => 'מנהל',
    'relationship_type_boss_female' => 'מנהלת',
    'relationship_type_boss_reverse' => 'כפוף',
    'relationship_type_boss_reverse_female' => 'כפוף',
    'relationship_type_boss_with_name' => 'המנהל של :name',
    'relationship_type_boss_female_with_name' => 'המנהלת של :name',
    'relationship_type_boss_reverse_with_name' => 'כפוף ל:name',
    'relationship_type_boss_reverse_female_with_name' => 'כפוף ל:name',

    'relationship_type_subordinate' => 'כפוף',
    'relationship_type_subordinate_female' => 'כפוף',
    'relationship_type_subordinate_reverse' => 'מנהל',
    'relationship_type_subordinate_reverse_female' => 'מנהלת',
    'relationship_type_subordinate_with_name' => 'כפוף ל:name',
    'relationship_type_subordinate_female_with_name' => 'כפוף ל:name',
    'relationship_type_subordinate_reverse_with_name' => 'המנהל של :name',
    'relationship_type_subordinate_reverse_female_with_name' => 'המנהלת של :name',
    ...
    'relationship_type_mentor_female_with_name' => 'חונכת של :name',
    'relationship_type_mentor_reverse_with_name' => 'חניך של :name',
    'relationship_type_mentor_reverse_female_with_name' => 'חניכה של :name',
    ...
    'relationship_type_protege_female_with_name' => 'חניך של :name',
    'relationship_type_protege_reverse_with_name' => 'חונך של :name',
    'relationship_type_protege_reverse_female_with_name' => 'חונכת של :name',
];
