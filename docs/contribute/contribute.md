...
1. `make build-dev` in the folder the repository has been cloned. This will run :
    - `composer install` to install all packages.
    - `npm install` to install all the front-end dependencies and tools needed to compile assets.
    - `npm run dev` to compile js and css assets.
