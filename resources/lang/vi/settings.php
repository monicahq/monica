...
return [
    ...
    'sidebar_settings_tags' => 'Quản lý thẻ',
    ...
    'name_order_firstname_lastname' => '<First name> <Last name> - Dũng Nguyễn',
    'name_order_lastname_firstname' => '<Last name> <First name> - Nguyễn Dũng',
    'name_order_firstname_lastname_nickname' => '<First name> <Last name> (<Nickname>) - Dũng Nguyễn (nhymxu)',
    'name_order_firstname_nickname_lastname' => '<First name> (<Nickname>) <Last name> - Dũng (nhymxu) Nguyễn',
    'name_order_lastname_firstname_nickname' => '<Last name> <First name> (<Nickname>) - Nguyễn Dũng (nhymxu)',
    'name_order_lastname_nickname_firstname' => '<Last name> (<Nickname>) <First name> - Nguyễn (nhymxu) Dũng',
    'name_order_nickname_firstname_lastname' => '<Nickname> (<First name> <Last name>) - nhymxu (Dũng Nguyễn)',
    'name_order_nickname_firstname_lastname' => '<Nickname> (<Last name> <First name>) - nhymxu (Nguyễn Dũng)',
    'name_order_nickname' => '<Nickname> - nhymxu',
    'currency' => 'Tiền tệ',
    'name' => 'Tên bạn: :name',
    'email' => 'Địa chỉ email',
    ...
    '2fa_enable_otp' => 'Mở ứng dụng mobile xác thực 2 yếu tố và quét mã QR dưới đây:',
