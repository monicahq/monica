    ...
    <div>
        <div class="">
            <h3>
                ...
                <span class="fr relative" style="top: -7px;">
                    <a @click="displayUploadZone = true" class="btn edit-information" v-if="displayUploadZone == false && displayUploadError == false && displayUploadProgress == false">Upload document</a>
                    <a @click="displayUploadZone = false; displayUploadError = false; displayUploadProgress = false" class="btn edit-information" v-if="displayUploadZone || displayUploadError || displayUploadProgress">Cancel</a>
                </span>
            </h3>
        </div>
        ...
        <transition name="fade">
            <div class="ba br3 document-upload-zone mb3 pa3" v-if="displayUploadError">
                ...
                <p class="tc mb3">There was an error uploading the document. Please try again below.</p>
                <p class="tc">
                    <input type="file" id="file" ref="file" v-on:change="handleFileUpload()"/>
                </p>
            </div>
        ...
        <!-- LIST OF DOCUMENTS -->
        <div class="table">
            <div class="table-row" v-for="document in documents" :key="document.id">
