            ...
            'information' => [
                'relationships' => $this->when(! $this->is_partial, [
                    'love' => [
                        ...
                        'contacts' => (is_null($this->getRelationshipsByRelationshipTypeGroup('love')) ? null : App\Models\Contacts\Contact::translateForAPI($this->getRelationshipsByRelationshipTypeGroup('love'))),
                    ],
                    'family' => [
                        ...
                        'contacts' => (is_null($this->getRelationshipsByRelationshipTypeGroup('family')) ? null : App\Models\Contacts\Contact::translateForAPI($this->getRelationshipsByRelationshipTypeGroup('family'))),
                    ],
                    'friend' => [
                        ...
                        'contacts' => (is_null($this->getRelationshipsByRelationshipTypeGroup('friend')) ? null : App\Models\Contacts\Contact::translateForAPI($this->getRelationshipsByRelationshipTypeGroup('friend'))),
                    ],
                    'work' => [
                        ...
                        'contacts' => (is_null($this->getRelationshipsByRelationshipTypeGroup('work')) ? null : App\Models\Contacts\Contact::translateForAPI($this->getRelationshipsByRelationshipTypeGroup('work'))),
                    ],
                ]),
                'dates' => [
                    'birthdate' => [
