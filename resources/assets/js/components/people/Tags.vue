...
<template>
  <div class="tc">
    <div v-show="editMode" class="mb3">
      ...
      <a class="pointer" @click.prevent="editMode = false" href="">
        {{ $t('app.cancel') }}
      </a>
      <a class="pointer" @click.prevent="store()" href="">
        {{ $t('app.save_close') }}
      </a>
    </div>
    ...
    <ul>
      ...
      <li v-show="contactTags.length > 0" class="di">
        <a v-show="!editMode" class="pointer" @click.prevent="editMode = true" href="">
          {{ $t('app.edit') }}
        </a>
      </li>
      <li v-show="contactTags.length == 0" class="di">
