...
return [
    ...
    'journal_entry_type_activity' => 'Δραστηριότητα',
    'journal_entry_rate' => 'Αξιολογήσατε την ημέρα σας.',
    'journal_add_comment' => 'Θέλετε να προσθέσετε ένα σχόλιο (προαιρετικό);',
    'journal_show_comment' => 'Προβολή σχολίων',
    'entry_delete_success' => 'Η καταχώρηση ημερολογίου έχει διαγραφεί επιτυχώς.',
    'journal_add_title' => 'Τίτλος (προαιρετικό)',
    'journal_add_date' => 'Ημερομηνία',
    'journal_add_post' => 'Καταχώριση',
    'journal_add_cta' => 'Aποθήκευση',
