...
<section class="ph3 ph0-ns">
  ...
  <div class="mt4 mw7 center mb3">
    <p><a href="{{ url('/people/'.$contact->$contact->hashID()) }}">< {{ $contact->getCompleteName() }}</a></p>
    <div class="mt4 mw7 center mb3">
  ...
  <div class="mw7 center br3 ba b--gray-monica bg-white mb6">
    ...
    <form action="/people/{{ $contact->$contact->hashID() }}/relationships/{{ $partner->$contact->hashID() }}" method="POST">
      {{ csrf_field() }}
      ...
      <div class="ph4-ns ph3 pv3 bb b--gray-monica">
        <div class="flex-ns justify-between">
          <div class="">
            <a href="/people/{{ $contact->$contact->hashID() }}" class="btn btn-secondary w-auto-ns w-100 mb2 pb0-ns">{{ trans('app.cancel') }}</a>
          </div>
          <div class="">
