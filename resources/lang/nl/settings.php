...
return [
    ...
    'export_title_json' => 'Exporteer naar JSON',
    'export_submitted' => 'Uw export is ingediend, het zal over enkele ogenblikken beschikbaar zijn…',
    'export_json_explanation' => 'Exporteren van je gegevens in Json formaat voor back-up.',
    'export_json_beta' => 'Json export is in voorvertoningsmodus. Vertel ons wat je ervan vindt:',
    'export_json_cta' => 'Exporteren naar Json',
    ...
    'export_empty_title' => 'Nog geen exports',
    ...
    'export_not_done' => 'Download onmogelijk, deze export is nog niet voltooid.',
    ...
    'delete_other_desc' => 'Uw gegevens in de hoofddatabase worden onmiddellijk verwijderd. Zoals beschreven in ons privacybeleid maken we dagelijks veilig versleutelde back-ups van de database. Deze back-ups worden 30 dagen lang bewaard, waarna ze volledig worden verwijderd. We kunnen specifieke gegevens niet eerder uit de back-ups verwijderen die we hebben. Al uw gegevens zullen niet later dan 31 dagen na het verwijderen van uw account worden verwijderd.',
    ...
    'subscriptions_account_current_legacy' => 'Huidig abonnement, niet selecteerbaar:',
    ...
    'subscriptions_account_bill_monthly' => 'We zullen <strong>:price</strong> voor nog eens <strong>maand</strong> in rekening brengen.',
    'subscriptions_account_bill_annual' => 'We zullen <strong>:price</strong> voor nog eens <strong>jaar</strong> in rekening brengen.',
    'subscriptions_account_change' => 'Abonnement wijzigen',

    'subscriptions_account_cancel_title' => 'Annuleer abonnement',
    'subscriptions_account_cancel_action' => 'Annuleer abonnement',
    ...
    'subscriptions_account_update_title' => 'Abonnement bijwerken',
    'subscriptions_account_update_description' => 'U kunt hier de frequentie van uw abonnement wijzigen.',
    'subscriptions_account_update_information' => 'Je wordt onmiddellijk gefactureerd voor het nieuwe bedrag. Je abonnement zal verlengen tot de nieuwe periode, afhankelijk van je keuze.',
    ...
    'subscriptions_downgrade_rule_contacts_archive' => 'We kunnen ook <a href=":url">al uw contacten voor u</a> archiveren - daarmee voldoet u aan de regel en u kunt gaan met het downgradeproces van uw account.',
    ...
    'subscriptions_plan_frequency_year' => ':amount / jaar',
    'subscriptions_plan_frequency_month' => ':amount / maand',
    ...
    'import_upload_rule_instructions' => 'Instructies voor het exporteren van <a href=":url1" target="_blank" rel="noopener noreferrer">macOS Contacts.app</a> en <a href=":url2" target="_blank" rel="noopener noreferrer">Google Contacten</a>.',
    'import_upload_rule_multiple' => 'Als uw contacten meerdere e-mailadressen of telefoonnummers hebben, wordt alleen de eerste vermelding opgeslagen.',
    'import_upload_rule_limit' => 'Bestanden mogen niet groter dan 10MB zijn.',
    'import_upload_rule_time' => 'Het kan tot een minuut duren om de contacten te uploaden en te verwerken. Een ogenblik geduld.',
    ...
    'import_upload_behaviour_help' => 'Vervangen zal alle gegevens in de vCard vervangen, maar zal bestaande contactvelden behouden.',
    ...
    'personalization_contact_field_type_modal_delete_description' => 'Weet je zeker dat je dit type contactveld wil verwijderen? Wanneer je dit type veld verwijderd, gaan ALLE gegevens van dit type contactveld bij alle contactpersonen verloren.',
    ...
    'personalization_contact_field_type_delete_success' => 'Het contactveldtype is successvol verwijderd.',
    ...
    'personalization_genders_modal_delete_question_default' => 'Deze genderidentiteit is de standaard. Als je dit gender verwijdert, welke wordt dan de nieuwe standaard?',
    ...
    'personalization_module_desc' => 'Mogelijk hebt u niet alle Monica\'s functies nodig. Hieronder kunt u specifieke functies uitschakelen die worden gebruikt op een contactblad. Deze wijziging heeft invloed op ALLE contacten. Het uitschakelen van een functie verwijdert geen gegevens, het verbergt de functie.',
    ...
    'personalization_life_event_category_description' => 'Een levensgebeurtenissen kan een type en categorie hebben. Jouw account komt met voorgedefinieerde categorieën en types, maar je kunt hier de levensgebeurtenis types personaliseren.',
    ...
    'personalization_life_event_type_modal_delete_desc' => 'Weet je zeker dat je dit type levensgebeurtenis wilt verwijderen? Levensgebeurtenissen die tot dit type behoren, worden verwijderd door deze actie uit te voeren.',
    'personalization_life_event_type_modal_delete_error' => 'We kunnen dit type activiteit niet vinden.',
    ...
    'personalization_life_event_type_removed_braces' => 'Heeft beugel verwijderd',
    'personalization_life_event_type_surgery' => 'Operatie ondergaan',
    'personalization_life_event_type_dentist' => 'Had tandartsbehandeling',
