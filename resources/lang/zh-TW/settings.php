...
return [
    ...
    'export_title' => '匯出帳戶資料',
    'export_be_patient' => '單擊按鈕開始匯出。處理匯出可能需要幾分鐘時間，請耐心等待, 不要取消按鈕。',
    'export_title_sql' => '匯出到 SQL',
    'export_sql_explanation' => '以 SQL 格式匯出資料使您可以將資料匯入到自己的 Monica 例項中。這隻在你有自己的伺服器時有效。',
    'export_sql_cta' => '匯出到 SQL',
    'export_sql_link_instructions' => '注意: <a href=":url">閱讀說明</a>, 瞭解有關將此檔案匯入到您的例項的詳細資訊。',
    ...
    'name_order_firstname_lastname_nickname' => '<名> <姓> (<暱稱>) - 小明 王 (狗蛋)',
    'name_order_firstname_nickname_lastname' => '<名> (<暱稱>) <姓> - 小明 (狗蛋) 王',
    'name_order_lastname_firstname_nickname' => '<姓> <名> (<暱稱>) - 王 小明 (狗蛋)',
    'name_order_lastname_nickname_firstname' => '<姓> (<暱稱>) <名> - 王 (狗蛋) 小明',
    ...
    'save' => '更新偏好',
    'delete_title' => '刪除您的帳戶',
    'delete_desc' => '您想要刪除您的帳戶嗎？警告：刪除是永久性的，您的所有資料將被永久刪除，如果您有訂閱的話也將立即取消',
    'delete_other_desc' => '宣告：您在主資料庫中的資料將立即刪除。 然而，正如我們的隱私政策所描述的那樣。 如果出現故障，我們會做資料庫的每日備份。備份將儲存30天——然後它將被完全刪除。 想象我們可以在所有備份中刪除您的特定資料是不現實的。 順便提一下，這種資料是在非常安全的亞馬遜伺服器上加密的，除了我們以外，沒有人擁有加密金鑰。 因此，您的資料將在 30 天后從所有備份中完全消失。',
    'reset_desc' => '您想重置您的帳戶嗎？這將刪除所有聯絡人以及與之關聯的資料。您的帳戶將不會被刪除。',
    'reset_title' => '刪除您的帳戶',
    'reset_cta' => '重置帳戶',
    'reset_notice' => '您確定要重新設定帳戶嗎？此操作不能回退。',
    'reset_success' => '您的帳戶已成功重置',
    'delete_notice' => '您確定要重新設定帳戶嗎？此操作不能回退。',
    'delete_cta' => '刪除帳戶',
    ...
    'password_new1' => '新密碼',
    'password_new1_placeholder' => '輸入一個新密碼',
    'password_new2' => '確認',
    ...
    'recovery_generate' => '正在生成程式碼...',
    'recovery_generate_help' => '請注意, 生成新程式碼將使以前生成的程式碼失效',
    ...
    'users_add_title' => '通過電子郵件邀請新使用者到您的帳戶',
    'users_add_description' => '此人將擁有與您相同的權利, 包括邀請其他使用者並刪除它們 (包括您)。因此, 請確保您信任此人。',
    'users_add_email_field' => '輸入您要邀請的人的電子郵件',
    'users_add_confirmation' => '我確認我想邀請這個使用者到我的帳戶。此人將訪問我的所有資料, 並與我所看到的一致。',
    ...
    'subscriptions_downgrade_rule_invitations' => '您不能有未接受的邀請',
    'subscriptions_downgrade_rule_invitations_constraint' => '您的帳戶中當前有 <a href=":url">:count 個未確認邀請</a>。',
    ...
    'subscriptions_upgrade_charge' => '您將支付 :price ，下次扣費日期：:date。如果您改變主意了，您可以隨時取消訂閱。',
    ...
    'subscriptions_help_opensource_desc' => 'Monica是一個開源專案，這意味著它是由社群建造的專案。開源意味著程式碼在 GitHub 上公開提供, 每個人都可以檢查並修改它。我們籌集的所有資金都致力於建立更好的功能, 擁有更強大的伺服器, 幫助支付賬單。沒有您的支援，我們將無法完成這一切。',
    'subscriptions_help_limits_title' => '你們對免費版的聯絡人有限制嗎？',
    ...
    'subscriptions_help_change_desc' => '您可以隨時取消您的訂閱。但是，目前為止我們無法提供退款服務。',
    ...
    'import_upload_rule_vcard' => '我們支援 vCard 3.0 格式, 這是Contacts.app (macOS) 和 Google Contacts的預設格式. 。',
    'import_upload_rule_instructions' => '匯出 <a href=":url1" target="_blank" rel="noopener noreferrer">Contacts.app (macOS)</a> 和 <a href=":url2" target="_blank" rel="noopener noreferrer">Google Contacts</a>的說明。',
    'import_upload_rule_multiple' => '現在, 如果您的聯絡人有多個電子郵件地址或電話號碼, 則只會獲取第一個條目。',
    'import_upload_rule_limit' => '檔案限制為10MB。',
    'import_upload_rule_time' => '上傳聯絡人和處理它們可能需要1分鐘的時間。請耐心等待。',
    ...
    'import_upload_behaviour_add' => '新增新條目, 跳過已有條目',
    'import_upload_behaviour_replace' => '替換現有條目',
    'import_upload_behaviour_help' => '提示: 替換會替換所有在 vCard 檔案中獲取的資料, 但是會保留未被替換的資訊區域。',
    ...
    'import_vcard_contact_no_firstname' => '無名字 (必填)',
    ...
    'tags_blank_description' => '標籤的工作方式類似於資料夾, 但可以向聯絡人新增多個標籤。轉到聯絡人並在名字的下面標記一個朋友,。一旦聯絡人被標記, 請返回此處管理帳戶中的所有標籤。',
    ...
    'api_authorized_clients_none' => '尚無授權客戶端',
    'api_authorized_clients_name' => '名稱',
    'api_authorized_clients_scopes' => '作用域',

    'personalization_tab_title' => '個性化您的帳戶',

    'personalization_title' => '在這裡您可以找到不同的設定來配置您的帳戶。這些功能更多的是針對想最大化控制Monica "高階使用者"所設定。',
    'personalization_contact_field_type_title' => '聯絡人欄位型別',
    'personalization_contact_field_type_add' => '新增新欄位型別',
    'personalization_contact_field_type_description' => '在這裡您可以配置所有不同型別的聯絡人欄位, 您可以關聯到所有聯絡人。如果將來出現新的社交網路, 您將能夠在這裡新增這種新的聯絡方式。',
    ...
    'personalization_contact_field_type_modal_delete_description' => '確實要刪除此聯絡人欄位型別嗎？刪除此型別的聯絡人欄位將刪除所有聯絡人的此型別的所有資料。',
    ...
    'personalization_contact_field_type_delete_success' => '聯絡人欄位型別已成功刪除。',
    ...
    'personalization_genders_modal_delete_desc' => '是否確實要刪除{name}？',
    'personalization_genders_modal_delete_question' => '這個性別下有{count} 個聯絡人，請您為這個聯絡人分配新的性別：|這個性別下有{count} 個聯絡人，請您為這些聯絡人分配新的性別',
    'personalization_genders_modal_delete_question_default' => '此性別為預設性別，如果您刪除此性別，您需要指定一個新的預設性別',
    'personalization_genders_modal_error' => '請從列表中選擇一個有效的性別。',
    ...
    'personalization_reminder_rule_desc' => '對於您設定的每個提醒, 我們可以在事件發生前幾天向您傳送電子郵件。您可以在此處切換這些通知。請注意, 這些通知只適用於每月和每年的提醒。',

    'personalization_module_save' => '更改已被儲存',
    'personalization_module_title' => '功能',
    'personalization_module_desc' => '有些人並不需要啟用所有功能。因此您可以在此處隱藏不需要的功能，該改動對所有聯絡人生效。',
    ...
    'reminder_time_to_send' => '應傳送每日提醒的時間',
    'reminder_time_to_send_help' => '基於您提供的資訊, 您的下一次提醒將在 <span title="{dateTimeUtc}" class="reminder-info">{dateTime}</span>傳送.',
    ...
    'personalization_activity_type_category_description' => '我們為您添加了一些預設活動及分類，您可以在此處修改它們。',
    ...
    'personalization_life_event_type_wear_glass_or_contact' => '戴眼鏡',
    'personalization_life_event_type_broken_bone' => '骨折',
    'personalization_life_event_type_removed_braces' => '移除了牙齒矯正器',
    'personalization_life_event_type_surgery' => '手術',
    'personalization_life_event_type_dentist' => '牙醫',
    'personalization_life_event_type_new_sport' => '新的運動',
    'personalization_life_event_type_new_hobby' => '新的愛好',
    'personalization_life_event_type_new_instrument' => '新樂器',
    'personalization_life_event_type_new_language' => '新語言',
    ...
    'storage_title' => '儲存空間',
    'storage_account_info' => '您的賬戶容量: :accountLimit Mb /  您目前已使用: :currentAccountSize Mb (:percentUsage%)',
    ...
    'archive_title' => '儲存您帳戶中的所有聯絡人',
    'archive_desc' => '這將存檔您帳戶中的所有聯絡人',
    'archive_cta' => '儲存所有聯絡人',

    'logs_title' => '此賬戶發生的所有情況',
