...
return [
    ...
    'today' => 'امروز',
    'yesterday' => 'دیروز',
    'another_day' => 'یک روز دیگر',
    'date' => 'تاریخ',
    'type' => 'نوع',
    'zoom' => 'بزرگنمايی',
    'upgrade' => 'برای باز کردن ارتقاء دهید',
    'percent_uploaded' => '{percent}% آپلود شد',
    'retry' => 'تلاش دوباره',
    'filter' => 'لیست را فیلتر کن',
    'go_back' => 'بازگشت',
    'file_selected' => 'یک فایل انتخاب شده …|{count} فایل انتخاب شده …',

    'application_title' => 'مونیکا - مدیریت روابط شخصی',
    'application_description' => 'مونیکا ابزاری برای مدیریت تعاملات شما با عزیزان، دوستان و خانواده خود است. ',
    'application_og_title' => 'با عزیزان خود روابط بهتری داشته باشید. CRM آنلاین رایگان برای دوستان و خانواده. ',

    'markdown_description' => 'آیا می خواهید متن خود را به خوبی قالب بندی کنید؟ ما از Markdown برای Bold، italic، لیست‌ها و موارد دیگر پشتیبانی می‌کنیم. ',
    'markdown_link' => 'مستندات را بخوانید',

    'header_settings_link' => 'تنظیمات',
    'header_logout_link' => 'خروج از سیستم',
    ...
    'footer_remarks' => 'نظرات؟',
    'footer_send_email' => 'یک ایمیل به ما بفرستید',
    'footer_privacy' => 'سیاست حفظ حریم خصوصی',
    'footer_release' => 'یادداشت‌های انتشار',
    'footer_newsletter' => 'خبرنامه',
    'footer_source_code' => 'مشارکت',
    'footer_version' => 'نسخه: :version',
    'footer_new_version' => 'یک نسخه جدید از مونیکا در دسترس می‌باشد.',

    'footer_modal_version_whats_new' => 'تغییرات جدید',
    ...
    'breadcrumb_dashboard' => 'پیشخوان',
    'breadcrumb_list_contacts' => 'لیست افراد',
    'breadcrumb_archived_contacts' => 'مخاطبین ارشیو شده',
    'breadcrumb_journal' => 'مجله',
    'breadcrumb_settings' => 'تنظیمات',
    'breadcrumb_settings_export' => 'خروجی',
    ...
    'breadcrumb_settings_import_upload' => 'بارگذاری',
    'breadcrumb_settings_tags' => 'برچسب ها',
    'breadcrumb_add_significant_other' => 'Add significant other',
    'breadcrumb_edit_significant_other' => 'Edit significant other',
    'breadcrumb_add_note' => 'افزودن يادداشت',
    'breadcrumb_edit_note' => 'ویرایش یادداشت',
    'breadcrumb_api' => 'وب سرویس',
    'breadcrumb_dav' => 'منابع DAV',
    'breadcrumb_edit_introductions' => 'How did you meet',
    'breadcrumb_settings_personalization' => 'شخصی سازی',
