...
return [
    ...
    'people_list_blank_cta' => '連絡先を追加する',
    'people_list_sort' => '並べ替え',
    'people_list_stats' => '1 contact|:count contacts',
    'people_list_firstnameAZ' => '名前でソート（A→Z）',
    'people_list_firstnameZA' => '名前でソート（Z→A）',
    'people_list_lastnameAZ' => '姓でソート（A→Z）',
    'people_list_lastnameZA' => '姓でソート（Z→A）',
    ...
    'people_list_clear_filter' => 'フィルターを解除',
    ...
    'section_personal_activities' => 'アクテビティ',
