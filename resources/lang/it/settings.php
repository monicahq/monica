...
return [
    ...
    'export_be_patient' => 'Clicca il pulsante per avviare l\'esportazione. L\'elaborazione dell\'esportazione potrebbe richiedere diversi minuti, sei pregato di esser paziente e non cliccare ripetutamente il pulsante.',
    'export_title_sql' => 'Esporta dati in SQL',
    'export_sql_explanation' => 'Esportare i tuoi dati in formato SQL ti consente di prendere i tuoi dati e importarli alla tua istanza di Monica. Ciò è utile solo se stai eseguendo Monica sul tuo server.',
    'export_sql_cta' => 'Esporta dati in SQL',
    'export_sql_link_instructions' => '<a href=":url">Leggi le istruzioni</a> per imparare come importare questo file nella tua istanza.',
