...
return [
    ...
    'relationship_type_ex_female_with_name' => 'ex-petit amie de :name',
    'relationship_type_ex_reverse_with_name' => 'ex-petit ami de :name',
    'relationship_type_ex_reverse_female_with_name' => 'ex-petit amie de :name',
    ...
    'relationship_type_parent_reverse_with_name' => 'fils de :name',
    'relationship_type_parent_reverse_female_wit1h_name' => 'fille de :name',
    ...
    'relationship_type_child_reverse_with_name' => 'père de :name',
    'relationship_type_child_reverse_female_with_name' => 'mère de :name',
    ...
    'relationship_type_sibling_reverse_with_name' => 'frère de :name',
    'relationship_type_sibling_reverse_female_with_name' => 'sœur de :name',
    ...
    'relationship_type_grandparent_with_name' => 'grand parent de :name',
    'relationship_type_grandparent_female_with_name' => 'grand parent de :name',
    'relationship_type_grandparent_reverse_with_name' => 'petit enfant de :name',
    'relationship_type_grandparent_reverse_female_with_name' => 'petit enfant de :name',
    ...
    'relationship_type_grandchild_female_with_name' => 'petit enfant de :name',
    'relationship_type_grandchild_reverse_with_name' => 'grand parent de :name',
    'relationship_type_grandchild_reverse_female_with_name' => 'grand parent de :name',

    'relationship_type_uncle' => 'oncle',
    'relationship_type_uncle_female' => 'tante',
    'relationship_type_uncle_reverse' => 'neveu',
    'relationship_type_uncle_reverse_female' => 'nièce',
    'relationship_type_uncle_with_name' => 'oncle de :name',
    'relationship_type_uncle_female_with_name' => 'tante de :name',
    'relationship_type_uncle_reverse_with_name' => 'neuveu de :name',
    'relationship_type_uncle_reverse_female_with_name' => 'nièce de :name',

    'relationship_type_nephew' => 'neveu',
    'relationship_type_nephew_female' => 'nièce',
    'relationship_type_nephew_reverse' => 'oncle',
    'relationship_type_nephew_reverse_female' => 'tante',
    'relationship_type_nephew_with_name' => 'neuveu de :name',
    'relationship_type_nephew_female_with_name' => 'nièce de :name',
    'relationship_type_nephew_reverse_with_name' => 'oncle de :name',
    'relationship_type_nephew_reverse_female_with_name' => 'tante de :name',
    ...
    'relationship_type_cousin_female_with_name' => 'cousin de :name',
    'relationship_type_cousin_reverse_with_name' => 'cousin de :name',
    'relationship_type_cousin_reverse_female_with_name' => 'cousin de :name',

    'relationship_type_godfather' => 'parrain',
    'relationship_type_godfather_female' => 'marraine',
    'relationship_type_godfather_reverse' => 'filleul',
    'relationship_type_godfather_reverse_female' => 'filleule',
    'relationship_type_godfather_with_name' => 'parrain de :name',
    'relationship_type_godfather_female_with_name' => 'marraine de :name',
    'relationship_type_godfather_reverse_with_name' => 'filleul de :name',
    'relationship_type_godfather_reverse_female_with_name' => 'filleule de :name',

    'relationship_type_godson' => 'filleul',
    'relationship_type_godson_female' => 'filleule',
    'relationship_type_godson_reverse' => 'parrain',
    'relationship_type_godson_reverse_female' => 'marraine',
    'relationship_type_godson_with_name' => 'filleul de :name',
    'relationship_type_godson_female_with_name' => 'filleule de :name',
    'relationship_type_godson_reverse_with_name' => 'parrain de :name',
    'relationship_type_godson_reverse_female_with_name' => 'marraine de :name',

    'relationship_type_friend' => 'ami·e',
    'relationship_type_friend_female' => 'ami·e',
    'relationship_type_friend_reverse' => 'ami·e',
    'relationship_type_friend_reverse_female' => 'ami·e',
    'relationship_type_friend_with_name' => 'ami·e de :name',
    'relationship_type_friend_female_with_name' => 'ami·e de :name',
    'relationship_type_friend_reverse_with_name' => 'ami·e de :name',
    'relationship_type_friend_reverse_female_with_name' => 'ami·e de :name',

    'relationship_type_bestfriend' => 'meilleur·e ami·e',
    'relationship_type_bestfriend_female' => 'meilleur·e ami·e',
    'relationship_type_bestfriend_reverse' => 'meilleur·e ami·e',
    'relationship_type_bestfriend_reverse_female' => 'meilleur·e ami·e',
    'relationship_type_bestfriend_with_name' => 'meilleur·e ami·e de :name',
    'relationship_type_bestfriend_female_with_name' => 'meilleur·e ami·e de :name',
    'relationship_type_bestfriend_reverse_with_name' => 'meilleur·e ami·e de :name',
    'relationship_type_bestfriend_reverse_female_with_name' => 'meilleur·e ami·e de :name',

    'relationship_type_colleague' => 'collègue',
    'relationship_type_colleague_female' => 'collègue',
    'relationship_type_colleague_reverse' => 'collègue',
    'relationship_type_colleague_reverse_female' => 'collègue',
    'relationship_type_colleague_with_name' => 'collègue de :name',
    'relationship_type_colleague_female_with_name' => 'collègue de :name',
    'relationship_type_colleague_reverse_with_name' => 'collègue de :name',
    'relationship_type_colleague_reverse_female_with_name' => 'collègue de :name',

    'relationship_type_boss' => 'patron',
    'relationship_type_boss_female' => 'patron',
    'relationship_type_boss_reverse' => 'subalterne',
    'relationship_type_boss_reverse_female' => 'subalterne',
    'relationship_type_boss_with_name' => 'patron de :name',
    'relationship_type_boss_female_with_name' => 'patron de :name',
    'relationship_type_boss_reverse_with_name' => 'subordonné de :name',
    'relationship_type_boss_reverse_female_with_name' => 'subordonné de :name',

    'relationship_type_subordinate' => 'subalterne',
    'relationship_type_subordinate_female' => 'subalterne',
    'relationship_type_subordinate_reverse' => 'patron',
    'relationship_type_subordinate_reverse_female' => 'patron',
    'relationship_type_subordinate_with_name' => 'subordonné de :name',
    'relationship_type_subordinate_female_with_name' => 'subordonné de :name',
    'relationship_type_subordinate_reverse_with_name' => 'patron de :name',
    'relationship_type_subordinate_reverse_female_with_name' => 'patron de :name',

    'relationship_type_mentor' => 'mentor',
    'relationship_type_mentor_female' => 'mentor',
    'relationship_type_mentor_reverse' => 'protégé',
    'relationship_type_mentor_reverse_female' => 'protégé',
    'relationship_type_mentor_with_name' => 'mentor de :name',
    'relationship_type_mentor_female_with_name' => 'mentor de :name',
    'relationship_type_mentor_reverse_with_name' => 'protégé de :name',
    'relationship_type_mentor_reverse_female_with_name' => 'protégé de :name',
    ...
    'relationship_type_protege_female_with_name' => 'protégé de :name',
    'relationship_type_protege_reverse_with_name' => 'mentor de :name',
    'relationship_type_protege_reverse_female_with_name' => 'mentor de :name',
];
