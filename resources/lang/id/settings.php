...
return [
    ...
    'export_be_patient' => 'Klik tombol untuk memulai ekspor. Mungkin membutuhkan beberapa menit untuk memproses data ekspor - harap bersabar dan jangan klik tombol nya berulang kali.',
    'export_title_sql' => 'Ekspor data ke SQL',
    'export_sql_explanation' => 'Mengekspor data Anda dalam format SQL mengizinkan Anda untuk mengambil data dan mengimpornya ke satu contoh pemasangan Monica milik Anda sendiri. Ini hanya berguna jika Anda menjalankan Monica pada server Anda sendiri.',
    'export_sql_cta' => 'Ekspor data ke SQL',
    'export_sql_link_instructions' => '<a href=":url">Baca instruksi</a> untuk mempelajari bagaimana cara mengimpor berkas ini ke dalam contoh pemasangan Anda.',
    ...
    'name_order_nickname_firstname_lastname' => '<Nickname> (<Last name> <First name>) – Kabayan (Surasep Asep)',
    ...
    'temperature_scale_celsius' => 'Selsius',
    'layout' => 'Tata letak',
    ...
    'delete_other_desc' => 'Data Anda dalam database utama akan segera dihapus. Seperti yang dijelaskan dalam kebijakan privasi kami, kami melakukan pencadangan harian, pencadangan terenkripsi dengan aman dari database tersebut dan pencadangan ini disimpan selama 30 hari dan setelah itu sepenuhnya akan dihapus. Kami tidak dapat menghapus data spesifik dari cadangan yang kami simpan lebih awal dari cadangan ini.  Semua data Anda akan sepenuhnya dihapus dalam 30 hari dari penghapusan akun Anda.',
    ...
    'locale_nl' => 'Belanda',
    'locale_pt' => 'Portugis',
    'locale_pt-BR' => 'Portugis (Brazil)',
    'locale_ru' => 'Rusia',
    'locale_sv' => 'Swedia',
    'locale_zh' => 'Bahasa Cina Disederhanakan',
    ...
    'subscriptions_downgrade_rule_contacts_constraint' => 'Saat ini Anda memiliki <a href=":url">1 kontak</a>.|Saat ini Anda memiliki <a href=":url">:count kontak</a>.',
    ...
    'subscriptions_plan_year_cost' => '$45/tahun',
    'subscriptions_plan_year_cost_save' => 'anda akan menghemat 25%',
    'subscriptions_plan_year_bonus' => 'Ketenangan pikiran untuk setahun penuh',
    'subscriptions_plan_month_title' => 'Bayar perbulan',
    'subscriptions_plan_month_cost' => '$5/bulan',
    ...
    'import_result_stat' => 'Unggahan vCard dengan 1 kontak (:total_imported yang diimpor, :total_skipped dilewatkan)|Unggahan vCard dengan :total_contacts kontak (:total_imported yang diimpor, :total_skipped dilewatkan)',
    ...
    'tags_list_contact_number' => '1 kontak|:count kontak',
    ...
    'personalization_genders_modal_delete_question' => 'Anda saat ini memiliki {count} kontak dengan jenis kelamin ini. Jika Anda menghapus jenis kelamin ini, jenis kelamin apa yang harus dimiliki kontak tersebut?|Anda saat ini memiliki {count} kontak dengan jenis kelamin ini. Jika Anda menghapus jenis kelamin ini, jenis kelamin apa yang harus dimiliki kontak tersebut?',
    ...
    'personalization_genders_list_contact_number' => '{count} kontak|{count} kontak',
    ...
    'personalization_reminder_rule_line' => '{count} hari sebelumnya|{count} hari sebelumnya',
