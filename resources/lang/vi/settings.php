...
return [
    ...
    'delete_other_desc' => 'Dữ liệu của bạn ở cơ sở dữ liệu chính sẽ bị xóa ngay lập tức. Như chúng tôi đã mô tả trong chính sách bảo mật, chúng tôi thực hiện sao lưu hàng ngày, bản sao lưu được mã hóa an toàn và được giữ trong vòng 30 ngày trước khi bị xóa hoàn toàn. Chúng tôi không xóa dữ liệu nào cụ thể khỏi bản sao lưu mà chúng tôi lưu trữ trước đó. Tất cả dữ liệu của bạn sẽ bị xóa hoàn toàn sau 30 ngày tài khoản của bạn bị xóa.',
    ...
    'import_result_stat' => 'Đã tải lên vCard với 1 liên hệ (đã nhập :total_imported, đã bỏ qua :total_skipped)|Đã tải lên vCard với 1 liên hệ (đã nhập :total_imported, đã bỏ qua :total_skipped)',
