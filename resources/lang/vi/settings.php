...
return [
    ...
    'export_title_sql' => 'Xuất dạng SQL',
    ...
    'export_sql_cta' => 'Xuất dạng SQL',
    'export_sql_link_instructions' => '<a href=":url">Đọc hướng dẫn</a> để xem cách nhập tệp này vào hệ thống của bạn.',
    'export_title_json' => 'Xuất file Json',
    'export_submitted' => 'File export của bạn đã được yêu cầu, nó sẽ xuất hiện sau vài phút…',
    'export_json_explanation' => 'Đang xuất dữ liệu của bạn ở định dạng Json để sao lưu.',
    'export_json_beta' => 'Xuất Json ở chế độ xem trước. Hãy cho chúng tôi những gì bạn nghĩ về nó:',
    'export_json_cta' => 'Xuất file Json',
    'export_header_type' => 'Kiểu',
    'export_header_timestamp' => 'Ngày khởi tạo',
    'export_header_status' => 'Trạng thái',
    'export_header_actions' => 'Hành động',
    'export_last_title' => 'Lần xuất cuối cùng',
    'export_empty_title' => 'Chưa xuất lần nào',
    'export_type_json' => 'Xuất file json',
    'export_type_sql' => 'Xuất file SQL',
    'export_status_todo' => 'Đã gửi',
    'export_status_doing' => 'Đang làm',
    'export_status_done' => 'Xong',
    'export_status_failed' => 'Thất bại',
    'export_not_done' => 'Không thể tải xuống, quá trình xuất này chưa được thực hiện.',
    ...
    'temperature_scale_fahrenheit' => 'Độ F (°F)',
    'temperature_scale_celsius' => 'Độ C (°C)',
    'layout' => 'Giao diện',
    ...
    'delete_other_desc' => 'Dữ liệu của bạn ở cơ sở dữ liệu chính sẽ bị xóa ngay lập tức. Như chúng tôi đã mô tả trong chính sách bảo mật, chúng tôi thực hiện sao lưu hàng ngày, bản sao lưu được mã hóa an toàn và được giữ trong vòng 30 ngày trước khi bị xóa hoàn toàn. Chúng tôi không xóa dữ liệu nào cụ thể khỏi bản sao lưu mà chúng tôi lưu trữ trước đó. Tất cả dữ liệu của bạn sẽ bị xóa hoàn toàn sau 31 ngày tài khoản của bạn bị xóa.',
    ...
    'subscriptions_account_current_legacy' => 'Gói hiện tại, không thể chọn được nữa:',
    'subscriptions_account_current_paid_plan' => 'Bạn đang dùng gói :name. Cảm ơn bạn vì đã đăng kí thuê bao.',

    'subscriptions_account_next_billing_title' => 'Hóa đơn tiếp theo',
    'subscriptions_account_next_billing' => 'Thuê bao của bạn sẽ tự động thanh toán vào <strong>:date</strong>.',
    'subscriptions_account_bill_monthly' => 'Chúng tôi sẽ tạo hóa đơn <strong>:price</strong> cho <strong>tháng</strong> khác.',
    'subscriptions_account_bill_annual' => 'Chúng tôi tạo hóa đơn <strong>:price</strong> cho <strong>năm</strong> khác.',
    'subscriptions_account_change' => 'Thay đổi gói',

    'subscriptions_account_cancel_title' => 'Hủy đăng ký',
    'subscriptions_account_cancel_action' => 'Hủy đăng ký',
    'subscriptions_account_cancel' => 'Bạn có thể hủy đăng ký bất kỳ lúc nào.',
    ...
    'subscriptions_account_update_title' => 'Cập nhật gói đăng ký Monica',
    'subscriptions_account_update_description' => 'Bạn có thể thay đổi gói đăng ký bất kỳ lúc nào.',
    'subscriptions_account_update_information' => 'Bạn sẽ được lập hóa đơn ngay lập tức cho thanh toán mới. Đăng ký của bạn sẽ kéo dài sang giai đoạn mới, tùy thuộc vào lựa chọn của bạn.',
    ...
    'subscriptions_downgrade_rule_contacts_archive' => 'Chúng tôi cũng có thể <a href=":url">lưu trữ tất cả các địa chỉ liên lạc của bạn cho bạn</a> – điều đó sẽ xóa quy tắc này và cho phép bạn tiếp tục quá trình hạ cấp tài khoản của mình.',
    'subscriptions_downgrade_cta' => 'Hạ cấp',
    'subscriptions_downgrade_success' => 'Bạn đã trở lại gói miễn phí!',
    'subscriptions_downgrade_thanks' => 'Cảm ơn rất nhiều vì đã thử gói trả phí. Chúng tôi liên tục bổ sung các tính năng mới trên Monica – vì vậy bạn có thể muốn quay lại trong tương lai để xem liệu bạn có muốn đăng ký lại hay không.',
    ...
    'subscriptions_plan_frequency_year' => ':amount / năm',
    'subscriptions_plan_frequency_month' => ':amount / tháng',
    ...
    'import_upload_behaviour' => 'Hành vi nhập:',
    ...
    'tags_list_delete_success' => 'Đã xóa thẻ thành công',
    'tags_list_delete_confirmation' => 'Bạn có chắc chắn muốn xóa thẻ không? Địa chỉ liên hệ sẽ không bị xóa, chỉ thẻ bị xóa.',
    ...
    'api_token_help' => 'Đây là mã thông báo truy cập cá nhân mới của bạn. Đây là lần duy nhất nó sẽ được hiển thị vì vậy đừng đánh mất nó! Bây giờ bạn có thể sử dụng mã thông báo này để thực hiện API.',
    ...
    'personalization_title' => 'Tại đây, bạn sẽ tìm thấy các cài đặt khác nhau để định cấu hình tài khoản của mình. Các tính năng này dành cho “người dùng nâng cao” muốn kiểm soát hoàn toàn Monica.',
    'personalization_contact_field_type_title' => 'Loại trường liên hệ',
    'personalization_contact_field_type_add' => 'Thêm loại trường mới',
    'personalization_contact_field_type_description' => 'Bạn có thể định cấu hình tất cả các loại trường liên hệ khác nhau mà bạn có thể liên kết với tất cả các liên hệ của mình. Ví dụ: nếu một mạng xã hội mới xuất hiện trong tương lai, bạn sẽ có thể thêm cách liên lạc mới này với các liên hệ của mình ngay tại đây.',
    ...
    'personalization_contact_field_type_modal_title' => 'Thêm một loại mục liên hệ mới',
    'personalization_contact_field_type_modal_edit_title' => 'Chỉnh sửa loại mục liên hệ hiện có',
    'personalization_contact_field_type_modal_delete_title' => 'Xóa một loại mục liên hệ hiện có',
    'personalization_contact_field_type_modal_delete_description' => 'Bạn có chắc chắn muốn xóa loại trường liên hệ này không? Việc xóa loại trường liên hệ này sẽ xóa TẤT CẢ dữ liệu có loại này đối với tất cả các địa chỉ liên hệ của bạn.',
    'personalization_contact_field_type_modal_name' => 'Tên',
    'personalization_contact_field_type_modal_protocol' => 'Giao thức (tùy chọn)',
    'personalization_contact_field_type_modal_protocol_help' => 'Có thể nhấp vào từng loại trường liên hệ mới. Nếu một giao thức được đặt, chúng tôi sẽ sử dụng giao thức đó để kích hoạt hành động được đặt.',
    ...
    'personalization_activity_type_category_description' => 'Một hoạt động với một trong các địa chỉ liên hệ của bạn có thể có một loại và một loại danh mục. Theo mặc định, tài khoản của bạn đi kèm với một tập hợp các loại danh mục được xác định trước nhưng bạn có thể tùy chỉnh các loại này tại đây.',
