...
return [
    ...
    'sidebar_settings_subscriptions' => 'Premium',
    ...
    'subscriptions_account_upgrade_choice' => 'Join over :customers persons who upgraded their Monica.',
    'subscriptions_account_invoices' => 'Invoices',
    'subscriptions_account_invoices_download' => 'Download',
    'subscriptions_account_payment' => 'Monica is offered as a one time payment.',
    ...
    'subscriptions_upgrade_choose' => 'Thank you for considering upgrading your account.',
    ...
    'subscriptions_upgrade_charge' => 'We’ll charge your card a one-time payment of USD $:price. You will not be charged again after this.',
    'subscriptions_upgrade_charge_cancellation' => 'For a small business owner like us, refunds cost a lot of money ($15 + the amount to refund, as dictated by Stripe). While we appreciate you want to upgrade today, please consider carefully if Monica is right for you as we will NOT do any refunds.',
    ...
    'subscriptions_help_discounts_desc' => 'We do! Monica is 50% off for students, non-profits and charities. Just contact <a href=":support">the support</a> with a proof of your status and we’ll apply this special status in your account.',
    'subscriptions_help_change_title' => 'What if I change my mind?',
    'subscriptions_help_change_desc' => 'There is no need to cancel your subscription because it\'s not a subscription based product. There is therefore no need to contact support or go through a boring cancellation process.',
