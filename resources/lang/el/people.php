...
return [
    ...
    'conversation_add_who_wrote' => 'Ποιος είπε αυτό το μήνυμα;',
    ...
    'information_edit_not_year' => 'Γνωρίζω την ημέρα και τον μήνα της ημέρας γενεθλίων αυτού του ατόμου, αλλά όχι το έτος…',
    'information_edit_exact' => 'Ξέρω την ακριβή ημέρα γενεθλίων αυτού του ατόμου...',
