...
return [
    ...
    'zoom' => '縮放',
    'upgrade' => '升級解鎖',
    'percent_uploaded' => '{percent}% 已上載',
    'retry' => '重試',
    'filter' => '篩選條件清單',
    'go_back' => '返回',
    'file_selected' => '已選1個文件...|已選{count}個文件 ...',

    'application_title' => 'Monica – 私人關係管理',
    'application_description' => 'Monica是一個管理您與親人朋友和家人互動的工具',
    'application_og_title' => '與親人擁有有更好的關係，適用於朋友和家人的免費在線CRM．',

    'markdown_description' => '想要很好地格式化文本？我們支持Markdown添加粗體，斜體，列表等。',
    'markdown_link' => '閲讀文檔',

    'header_settings_link' => '設置',
    'header_logout_link' => '登出',
    'header_changelog_link' => '產品改變',

    'main_nav_cta' => '加入連絡人',
    'main_nav_dashboard' => '儀表板',
    'main_nav_family' => '聯繫人',
    'main_nav_journal' => '日誌',
    ...
    'footer_remarks' => '有話要説？',
    'footer_send_email' => '發送信件給我',
    'footer_privacy' => '隱私權政策',
    'footer_release' => '版本資訊',
    'footer_newsletter' => '電子報',
    'footer_source_code' => '貢獻',
    'footer_version' => '版本: :version',
    'footer_new_version' => '有可用的新版本',

    'footer_modal_version_whats_new' => '更新內容',
    ...
    'breadcrumb_list_contacts' => '聯絡人列表',
    'breadcrumb_archived_contacts' => '封存的聯絡人',
    'breadcrumb_journal' => '日誌',
    'breadcrumb_settings' => '設置',
    ...
    'breadcrumb_settings_import_report' => '匯入報告',
