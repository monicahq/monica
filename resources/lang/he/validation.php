...
return [
    ...
    */
    ...
    'alpha_dash' => ':attribute יכול להכיל רק אותיות, מספרים, מינוסים וקווים תחתיים.',
    ...
    'date_equals' => ':attribute חייב להיות תאריך כמו :date.',
    ...
    'gt' => [
        'numeric' => ':attribute חייב להיות גדול מאשר :value.',
        'file' => ':attribute חייב להיות גדול מ־:value קילובתים.',
        'string' => ':attribute חייב להיות גדול מ־:value תווים.',
        'array' => 'תחת :attribute חייבים להיות יותר מ־:value פריטים.',
    ],
    'gte' => [
        'numeric' => ':attribute חייב להיות גדול או שווה ל־:value.',
        'file' => 'הגודל של :attribute חייב להיות גדול או שווה ל־:value קילובתים.',
        'string' => 'האורך של :attribute חייב להיות גדול או שווה ל־:value תווים.',
        'array' => 'תחת :attribute חייבים להיות :value פריטים או יותר.',
    ],
    ...
    'lt' => [
        'numeric' => ':attribute חייב להיות קטן מאשר :value.',
    ...
    'lte' => [
        ...
        'file' => 'הגודל של :attribute חייב להיות פחות או שווה ל־:value קילובתים.',
        'string' => 'האורך של :attribute חייב להיות פחות או שווה ל־:value תווים.',
        'array' => 'תחת :attribute לא יכולים להיות יותר מ־:value פריטים.',
    ],
    'max' => [
    ...
    'uuid' => ':attribute חייב להיות מזה ייחודי תקני.',
