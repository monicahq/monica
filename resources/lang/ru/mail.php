...
return [
    ...
    'want_reminded_of' => 'Вы хотели быть уведомлены о :reason',
    'for' => 'Для: :name',
    'comment' => 'Комментарий: :comment',
    'footer_contact_info' => 'Добавить, просмотреть, завершить и изменить информацию об этом контакте',
    'footer_contact_info2' => 'Смотрите профиль :name',
    'footer_contact_info2_link' => 'Смотрите профиль :name: :url',

    'notification_subject_line' => 'У вас есть предстоящее событие',
