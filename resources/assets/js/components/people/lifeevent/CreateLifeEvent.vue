...
<template>
    <section class="ph3 ph0-ns life-event">
        <div class="mt4 mw7 center mb3">
            ...
            <!-- Breadcrumb -->
            <ul v-if="view == 'types'" class="ba b--gray-monica pa2 mb2">
                <li class="di"><a class="pointer" @click="view = 'categories'">All categories</a></li>
                <li class="di">{{ this.activeCategory }}</li>
            </ul>
            ...
            <ul class="ba b--gray-monica br2">
                ...
                <!-- TYPES -->
                <li class="relative pointer bb b--gray-monica b--gray-monica pa2 life-event-add-row" v-for="type in types" @click="getType(category)" v-if="view == 'types'">
                    <div class="dib mr2">
