            ...
            <h3>
                📄 {{ $t('people.photo_list_title') }}
                 <span class="fr relative" style="top: -7px;" v-show="reachLimit == 'false'">
                    ...
                    <a @click="displayUploadZone = false; displayUploadError = false; displayUploadProgress = false" class="btn" v-if="displayUploadZone || displayUploadError || displayUploadProgress">{{ $t('app.cancel') }}</a>
                </span>
            </h3>
        </div>
        ...
        <transition name="fade">
            <div class="ba br3 photo-upload-zone mb3 pa3" v-if="displayUploadZone">
                ...
                <div class="tc dib w-100 relative">
                    <button class="btn">{{ $t('people.photo_upload_zone_cta') }}</button>
