    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-9">
        ...
        <form class="settings-reset">
          ...
          <div class="form-group">
            @if ($is2FAActivated)
              <a href="{{ url('settings/security/2fa-disable') }}" class="btn btn-warning">{{ trans('settings.2fa_enable_title') }}</a>
            @else
              <a href="{{ url('settings/security/2fa-enable') }}" class="btn btn-primary">{{ trans('settings.2fa_disable_title') }}</a>
            @endif
          </div>          
        </form>

        <form class="settings-reset">
          <h2>Recuperation codes</h2>
