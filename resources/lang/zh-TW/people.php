...
return [
    ...
    'people_list_lastactivitydateNewtoOld' => '依最後活動日期從近到遠排序',
    'people_list_lastactivitydateOldtoNew' => '依最後活動日期從遠到近排序',
    ...
    // Conversation
    'conversation_blank' => '記錄你與 :name 在其他社交媒體的對話紀錄',
    ...
    'activities_add_pick_activity' => '是否對這活動進行分類? 這能為你提供統計數據(可選)',
    ...
    'life_event_category_work_education' => '成長生涯',
    'life_event_category_family_relationships' => '親情愛情',
    'life_event_category_home_living' => '生活日常',
    'life_event_category_health_wellness' => '健康保健',
    'life_event_category_travel_experiences' => '人生經歷',
