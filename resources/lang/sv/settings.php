...
return [
    ...
    'subscriptions_downgrade_rule_invitations_constraint' => 'Du har för närvarande <a href=":url">1 väntande inbjudan</a> skickad till people.<unk> Du har <a href=":url">:count väntande inbjudningar</a> skickad till folk.',
    'subscriptions_downgrade_rule_contacts' => 'Du får inte ha fler än :number aktiva kontakter',
    'subscriptions_downgrade_rule_contacts_constraint' => 'Du har för närvarande <a href=":url">1 kontakt</a>.<unk> Du har <a href=":url">:count kontakter</a>.',
    ...
    'import_result_stat' => 'Uppladdad vCard med 1 kontakt (:total_import importerad, :total_skipped hoppas över)<unk> Uppladdad vCard med :total_contacts kontakter (:total_imported importerad, :total_skipped hoppas över)',
