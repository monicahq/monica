...
return [
    'sidebar_settings' => 'تنظیمات حساب',
    'sidebar_personalization' => 'شخصی سازی',
    'sidebar_settings_storage' => 'فضای ذخیره سازی',
    'sidebar_settings_export' => 'استخراج داده',
    'sidebar_settings_users' => 'کاربران',
    'sidebar_settings_subscriptions' => 'اشتراک',
    'sidebar_settings_import' => 'وارد کردن دیتا',
    'sidebar_settings_tags' => 'مدیریت برچسب ها',
    'sidebar_settings_api' => 'وب سرویس',
    'sidebar_settings_dav' => 'منابع DAV',
    'sidebar_settings_security' => 'امنیت',
    'sidebar_settings_auditlogs' => 'گزارش های حسابرسی',

    'title_general' => 'اطلاعات عمومی',
    'title_i18n' => 'تنظیمات بین المللی',
    'title_layout' => 'طرح بندی',

    'me_title' => 'من بعنوان مخاطب',
    'me_help' => 'این مخاطب <em>شما</em> را در مونیکا نشان می دهد
',
    'me_select' => 'مخاطب را انتخاب کنید',
    'me_no_contact' => 'هیچ مخاطبی انتخاب نشده است.',
    'me_select_click' => 'برای انتخاب یک مخاطب اینجا کلیک کنید',
    'me_remove_contact' => 'انجمن را حذف کنید',
    'me_choose' => 'خودتان را انتخاب کنید',
    'me_choose_placeholder' => 'خودتان را انتخاب کنید',

    'export_title' => 'داده های حساب خود را برون ریزی  کنید',
    'export_be_patient' => 'برای شروع برون ریزی روی دکمه کلیک کنید. این عملیات ممکن است چند دقیقه طول بکشد  - لطفاً صبور باشید و مکرراً روی دکمه کلیک نکنید.',
    'export_title_sql' => 'برون ریزی داده ها به SQL',
    'export_sql_explanation' => 'برون ریزی داده ها در قالب SQL به شما این امکان را می دهد تا داده های خود را بردارید و به نمونه Monica خود وارد کنید. این فقط در صورتی مفید است که مونیکا را روی سرور خود اجرا کنید.',
    'export_sql_cta' => 'برون ریزی داده ها به SQL',
    'export_sql_link_instructions' => 'برای یادگیری نحوه درون ریزی این فایل در دیتابیس <a href=":url">دستورالعمل</a> را مطالعه کنید.',

    'firstname' => 'نام',
    'lastname' => 'نام خانوادگی',
    'name_order' => 'ترتیب نام',
    'name_order_firstname_lastname' => '<First name> <Last name> – صالح شریفی',
    'name_order_lastname_firstname' => '<Last name> <First name> – شریفی صالح',
    'name_order_firstname_lastname_nickname' => 'صالح شریفی (فرمانده)',
    'name_order_firstname_nickname_lastname' => 'صالح (فرمانده) شریفی',
    'name_order_lastname_firstname_nickname' => '<Last name> <First name> (<Nickname>) – شریفی صالح (فرمانده)',
    'name_order_lastname_nickname_firstname' => '<Last name> (<Nickname>) <First name> – شریفی (فرمانده) صالح',
    'name_order_nickname_firstname_lastname' => '<Nickname> (<First name> <Last name>) – فرمانده (صالح شریفی)',
    'name_order_nickname_lastname_firstname' => '<Nickname> (<Last name> <First name>) – فرمانده (شریفی صالح)',
    'name_order_nickname' => '<Nickname> – فرمانده',
    'currency' => 'واحدپول',
    'name' => 'نام شما: :name',
    'email' => 'آدرس ایمیل',
    'email_placeholder' => 'ایمیل را وارد کنید',
    'email_help' => 'از این ایمیل برای ورود و همچنین ارسال یاد آوری ها استفاده می شود.',
    'timezone' => 'منقطه زمانی',
    'temperature_scale' => 'مقیاس دما',
    'temperature_scale_fahrenheit' => 'فارانهایت',
    'temperature_scale_celsius' => 'سلسیوس (سانتی‌گراد)',
    'layout' => 'Layout',
    ...
    '2fa_otp_title' => 'اپلیکیشن موبایل احرازهویت دومرحله ای 2FA',
    '2fa_enable_title' => 'فعال‌سازی احرازهویت دو مرحله‌ای',
    '2fa_enable_description' => 'برای افزایش امنیت حساب خود، احراز هویت دو عاملی را فعال کنید.',
    '2fa_enable_otp' => 'برنامه تلفن همراه احراز هویت دو عاملی خود را باز کنید و بارکد QR زیر را اسکن کنید:',
    '2fa_enable_otp_help' => 'اگر برنامه موبایل احراز هویت دو عاملی شما از بارکد QR پشتیبانی نمی کند، کد زیر را وارد کنید:',
    '2fa_enable_otp_validate' => 'لطفاً دستگاه جدیدی را که به تازگی راه‌اندازی کرده‌اید تأیید کنید:',
