...
return [
    ...
    'delete_desc' => 'Θέλετε να διαγράψετε τον λογαριασμό σας? Προειδοποίηση: η διαγραφή είναι μόνιμη και όλα τα δεδομένα σας θα διαγραφούν οριστικά. Η συνδρομή σας (αν έχετε) θα ακυρωθεί αμέσως.',
    ...
    'reset_desc' => 'Θέλετε να επαναφέρετε τον λογαριασμό σας? Αυτό θα καταργήσει όλες τις επαφές σας και τα δεδομένα που σχετίζονται με αυτές. Ο λογαριασμός σας δεν θα διαγραφεί.',
    'reset_title' => 'Επαναφορά του λογαριασμού σας',
    'reset_cta' => 'Επαναφορά λογαριασμού',
    'reset_notice' => 'Είστε βέβαιοι ότι θέλετε να επαναφέρετε το λογαριασμό σας; Δεν μπορεί να γίνει αναίρεση.',
    'reset_success' => 'Η επαναφορά του λογαριασμού σας έγινε με επιτυχία',
    'delete_notice' => 'Είστε βέβαιοι ότι θέλετε να διαγράψετε το λογαριασμό σας; Δεν μπορεί να γίνει αναίρεση.',
    ...
    'locale_pt-BR' => 'Πορτογαλικά (Βραζιλίας)',
    'locale_ru' => 'Ρωσικά',
    'locale_sv' => 'Σουηδικά',
    ...
    'password_new1_placeholder' => 'Εισάγετε ένα νέο κωδικό',
    'password_new2' => 'Επιβεβαίωση',
    'password_new2_placeholder' => 'Γράψτε ξανά τον κωδικό',
    ...
    'reminder_time_to_send' => 'Ώρα της ημέρας για αποστολή υπενθυμίσεων',
