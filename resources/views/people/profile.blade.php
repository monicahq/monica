        ...
        <div class="row">
          <div class="col-xs-12 col-sm-3 profile-sidebar">
            ...
            <div class="ba b--near-white br2 bg-gray-monica pa3 mb3 f6">
              ...
              <p class="mb0">
                {{ $weather->getEmoji() }} {{ trans('app.weather_'.$weather->summary_icon) }} / {{ trans('app.weather_current_temperature_'.auth()->user()->temperature_scale, ['temperature' => $weather->temperature]) }}
              </p>
            </div>
            @endif
