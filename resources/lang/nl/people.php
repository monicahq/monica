...
return [
    ...
    'people_list_number_kids' => ':count kind|:count kinderen',
    'people_list_last_updated' => 'Laatst bekeken:',
    'people_list_number_reminders' => ':count herinnering|:count herinneringen',
    'people_list_blank_title' => 'Je hebt nog niemand in je account',
    'people_list_blank_cta' => 'Voeg iemand toe',
    'people_list_sort' => 'Sorteer',
    'people_list_stats' => ':count contact|:count contacten',
    ...
    'people_list_lastactivitydateNewtoOld' => 'Sorteren op laatste activiteitdatum, nieuwste naar oudste',
    'people_list_lastactivitydateOldtoNew' => 'Sorteren op laatste activiteitdatum, oudste naar nieuwste',
    'people_list_filter_tag' => 'Tonen alle contactpersonen gelabeld met',
    'people_list_clear_filter' => 'Filter wissen',
    'people_list_contacts_per_tags' => ':count contact|:count contacten',
    ...
    'archived_contact_readonly' => 'Gearchiveerd contactpersoon kan niet worden bewerkt, verwijder deze eerst.',
    ...
    'people_add_email' => 'E-mailadres (optioneel)',
    'people_add_nickname' => 'Alias (optioneel)',
    ...
    'people_delete_confirmation' => 'Weet je zeker dat je :name\'s contactgegevens wilt verwijderen? Verwijderen is onmiddellijk en permanent.',
    ...
    'people_add_reminder_for_birthday' => 'Maak een jaarlijkse verjaardag herinnering',
    ...
    'contact_archive_help' => 'Gearchiveerde contacten worden niet getoond in de lijst met contactpersonen, maar worden nog steeds weergegeven in zoekresultaten.',
    ...
    'stay_in_touch_modal_label' => 'Stuur me iedere… {count} dag|Stuur me een e-mail iedere… {count} dagen',
    ...
    // Conversation
    'conversation_blank' => 'Registreer gesprekken die je hebt met :name op sociale media, SMS…',
    ...
    'conversation_add_who_wrote' => 'Wie heeft dit bericht verzonden?',
    ...
    // age - birthday
    'birthdate_not_set' => 'Geboortedatum is niet ingesteld',
    ...
    'information_edit_not_year' => 'Ik weet de dag en de maand van de verjaardag van deze persoon, maar niet het jaar…',
    'information_edit_exact' => 'Ik weet precies wanneer deze persoon jarig is…',
    ...
    'work_edit_success' => 'Werkinformatie bijgewerkt',
    ...
    'activities_add_pick_activity' => 'Wil je deze activiteit categoriseren? Het hoeft niet, maar levert je later statistieken op. (optioneel)',
    ...
    'deceased_mark_person_deceased' => 'Markeer dit als overleden',
    'deceased_know_date' => 'Ik weet de datum waarop deze persoon is gestorven',
    ...
    'life_event_create_date' => 'Je hoeft geen maand of dag aan te geven - alleen het jaar is verplicht.',
    ...
    'document_upload_zone_progress' => 'Document uploaden…',
