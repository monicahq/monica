...
return [
    ...
    'export_title_sql' => 'ייצוא נתונים ל־SQL',
    'export_sql_explanation' => 'יצוא הנתונים שלך במבנה SQL מאפשר לך לקחת את הנתונים שלך ולייבא אותם לעותק של מוניקה משלך. תכונה זו שימושית למקרה שיש לך עותק של מוניקה על שרת משלך.',
    'export_sql_cta' => 'ייצוא נתונים ל־SQL',
    'export_sql_link_instructions' => '<a href=":url">יש לקרוא את ההנחיות</a> כדי להבין יותר לעומק כיצד לייבא את הקובץ הזה לתוך העותק שלך.',
    ...
    'name_order_nickname_firstname_lastname' => '<כינוי>‏ (<שם משפחה> <שם פרטי>) – שרוליק (ישראלי ישראל)',
    ...
    'storage_title' => 'אחסון',
    'storage_account_info' => 'מגבלת החשבון שלך היא: :accountLimit מגה סיביות. הניצולת הנוכחית שלך היא: :currentAccountSize מגה סיביות (בערך :percentUsage%).',
