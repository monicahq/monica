...
return [
    ...
    'export_be_patient' => 'Cliquez sur le bouton pour commencer l’export. Cela peut prendre plusieurs minutes pour préparer l’export – merci d’être patient et de ne pas re-clicker sur le bouton.',
    ...
    'export_sql_link_instructions' => '<a href=":url">Lisez les instructions</a> afin d’en savoir plus sur comment importer ce fichier dans votre instance.',
