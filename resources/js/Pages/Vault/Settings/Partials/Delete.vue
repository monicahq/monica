  ...
  <div>
    ...
    <div class="sm:flex items-center justify-between mb-3 sm:mt-0 mt-8">
      <h3 class="mb-4 sm:mb-0">
        <span class="mr-1">
          🗑
        </span> Delete the vault
      </h3>
    </div>

    <!-- help text -->
    <div class="border rounded mb-6 text-sm">
      <div class="px-3 py-2 rounded-t flex bg-slate-50 border-gray-200 border-b mb-2">
        ...
        <div>
          <p>Deleting the vault means deleting all the data inside this vault, forever. There is no turning back. Please be certain.</p>
        </div>
      </div>

      <p class="px-5 py-2 mb-1 text-center">
