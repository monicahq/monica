...
return [
    ...
    'food_preferencies_edit_description' => 'Возможно :firstname или кто-то :family\'s family has an allergy. Or doesn\'t like a specific bottle of wine. Indicate them here so you will remember it next time you invite them for dinner',
    ...
    'reminders_add_description' => 'Напомните мне о',
    'reminders_add_predefined' => 'Предопределённое напоминание',
    'reminders_add_custom' => 'Специальное напоминание',
    'reminders_add_next_time' => 'Когда в следующий раз вы хотите получить напоминание об этом?',
    'reminders_add_once' => 'Один раз',
    'reminders_add_recurrent' => 'Повторять напоминание. Периодичность: ',
    ...
    'activities_add_pick_activity' => '(Не обязательно) Would you like to categorize this activity? You don\'t have to, but it will give you statistics later on',
