...
return [
    ...
    'export_be_patient' => 'Klik op de knop om het exporteren te starten. Het kan enige minuten duren om de export te verwerken - Wees alstublieft geduldig en klik niet meerdere malen op de knop.',
    'export_title_sql' => 'Exporteer naar SQL',
    'export_sql_explanation' => 'Het exporteren van uw gegevens in SQL formaat stelt u in staat om uw gegevens te importeren in uw eigen Monica installatie. Dit is alleen waardevol als u uw eigen server heeft.',
    'export_sql_cta' => 'Exporteer naar SQL',
    'export_sql_link_instructions' => 'Opmerking: <a href=":url"> lees de instructies</a> om meer te weten te komen over het importeren van dit bestand in uw eigen installatie.',
    ...
    'email_help' => 'Dit is het e-mailadres wat u gebruikt om in te loggen en hier worden ook uw herinneringen naar verstuurd.',
    'timezone' => 'Tijdzone',
    ...
    'save' => 'Update voorkeuren',
    'delete_title' => 'Verwijder uw account',
    'delete_desc' => 'Wenst u uw account te verwijderen? Waarschuwing: verwijdering is permanent en al uw gegevens zullen permanent worden verwijderd.',
    'reset_desc' => 'Wilt u uw account resetten? Hiermee verwijdert u alle contactpersonen en de gegevens die hieraan zijn gekoppeld. Uw account zal niet worden verwijderd.',
    'reset_title' => 'Reset uw account',
    'reset_cta' => 'Account resetten',
    'reset_notice' => 'Weet u zeker dat u uw account wil resetten? Laatste waarschuwing.',
    'reset_success' => 'Uw account is met succesvol gereset',
    'delete_notice' => 'Weet u zeker dat u uw account wil verwijderen? Laatste waarschuwing.',
    ...
    'recovery_help_intro' => 'Dit zijn uw herstelcodes:',
    'recovery_help_information' => 'U kunt elke herstelcode eenmalig gebruiken.',
