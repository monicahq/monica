...
return [
    ...
    'u2f_title' => 'U2F Sicherheitsschlüssel',
    'u2f_enable_description' => 'Neuen U2F Sicherheitsschlüssel hinzufügen',
    'u2f_key_name_help' => 'Geben Sie Ihrem Schlüssel einen Namen.',
    'u2f_key_name' => 'Schlüsselname:',
    'u2f_buttonAdvise' => 'Wenn Ihr Sicherheitsschlüssel einen Knopf hat, drücken Sie ihn.',
    'u2f_noButtonAdvise' => 'Wenn nicht, entfernen Sie ihn und fügen Sie ihn erneut ein.',
    'u2f_success' => 'Ihr Schlüssel wurde erkannt und validiert.',
    'u2f_insertKey' => 'Fügen Sie Ihren Sicherheitsschlüssel ein.',
    'u2f_error_other_error' => 'Ein Fehler ist aufgetreten.',
    'u2f_error_bad_request' => 'Die besuchte URL passt nicht zur App-ID oder Sie verwenden kein HTTPS',
    'u2f_error_configuration_unsupported' => 'Client-Konfiguration wird nicht unterstützt.',
    'u2f_error_device_ineligible' => 'Das Gerät ist für diese Anfrage nicht berechtigt. Für eine Registrierungsanfrage kann dies bedeuten, dass das Token bereits registriert ist, für eine Signaturanfrage, dass der Token den angegebenen Schlüssel unterstützt.',
    'u2f_error_timeout' => 'Zeitüberschreitung.',
    'u2f_last_use' => 'Letzte Verwendung: {timestamp}',
    'u2f_delete_confirmation' => 'Diesen Schlüssel wirklich löschen?',
    'u2f_delete_success' => 'Schlüssel gelöscht',
