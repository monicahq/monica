...
class CountriesHelper
{
     ...
     */
    public static function getDefaultTimezone(Country $country): string
    {
    ...
    /**
     * Get default distance format for the country.
     */
    public static function getDefaultDistanceFormat(Country $country): string
    {
        switch ($country->getIsoAlpha3()) {
            case 'USA':
            case 'LBR':
            case 'MMR':
                return User::DISTANCE_UNIT_MILES;
            default:
                return User::DISTANCE_UNIT_KM;
        }
    }

    /**
     * Get default date format for the country.
     */
    public static function getDefaultDateFormat(Country $country): string
    {
        switch ($country->getIsoAlpha3()) {
            case 'USA':
                return 'MMM DD, YYYY';
