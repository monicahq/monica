...
return [
    ...
    'reminder_frequency_day' => 'her gün|:number günde bir',
    'reminder_frequency_week' => 'her hafta|:number haftada bir',
    'reminder_frequency_month' => 'her ay|:number ayda bir',
    'reminder_frequency_year' => 'her yıl|:number yılda bir',
    ...
    'relationship_form_associate_contact' => 'Ekli olan bir kişi',
    'relationship_form_associate_dropdown' => 'Aşağıdaki açılır listeden mevcut bir bağlantıyı arayın ve seçin',
    'relationship_form_associate_dropdown_placeholder' => 'Mevcut bir bağlantıyı arayın ve seçin',
    'relationship_form_also_create_contact' => 'Bu kişi için bir Bağlantı girişi oluşturun.',
    'relationship_form_add_description' => 'Bu, bu kişiye diğer bağlantılar gibi davranmanıza izin verecektir.',
