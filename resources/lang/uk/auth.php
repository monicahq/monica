...
return [
    ...
    */
    ...
    'signup' => 'Реєстрація',
    'create_account' => 'Створіть перший обліковий запис на <a href=":url">сторінці реєстрації</a>',
    'change_language_title' => 'Змінити мову:',
    'change_language' => 'Змінити мову на :lang',

    'password_reset_title' => 'Скинути пароль',
    'password_reset_email' => 'Адреса електронної пошти',
    'password_reset_send_link' => 'Надіслати посилання для скидання пароля',
    'password_reset_password' => 'Пароль',
    'password_reset_password_confirm' => 'Підтвердження пароля',
    'password_reset_action' => 'Скинути пароль',
    'password_reset_email_content' => 'Натисніть сюди, щоб скинути пароль:',
