...
return [
    ...
    'relationship_type_partner_reverse' => 'conjoint',
    'relationship_type_partner_reverse_female' => 'conjointe',
    'relationship_type_partner_with_name' => 'conjoint de :name',
    'relationship_type_partner_female_with_name' => 'conjointe de :name',
    'relationship_type_partner_reverse_with_name' => 'conjoint de :name',
    'relationship_type_partner_reverse_female_with_name' => 'conjointe de :name',
    ...
    'relationship_type_date_reverse' => 'rendez-vous',
    'relationship_type_date_reverse_female' => 'rendez-vous',
    'relationship_type_date_with_name' => 'rendez-vous de :name',
    'relationship_type_date_female_with_name' => 'rendez-vous de :name',
    'relationship_type_date_reverse_with_name' => 'rendez-vous de :name',
    'relationship_type_date_reverse_female_with_name' => 'rendez-vous de :name',

    'relationship_type_lover' => 'amant',
    'relationship_type_lover_female' => 'amante',
    'relationship_type_lover_reverse' => 'amant',
    'relationship_type_lover_reverse_female' => 'amante',
    'relationship_type_lover_with_name' => 'amant de :name',
    'relationship_type_lover_female_with_name' => 'amante de :name',
    'relationship_type_lover_reverse_with_name' => 'amant de :name',
    'relationship_type_lover_reverse_female_with_name' => 'amante de :name',
    ...
    'relationship_type_inlovewith_reverse_with_name' => 'amant secret de :name',
    'relationship_type_inlovewith_reverse_female_with_name' => 'amante secrète de :name',

    'relationship_type_lovedby' => 'aimé par',
    'relationship_type_lovedby_female' => 'aimée par',
    'relationship_type_lovedby_reverse' => 'amoureux de',
    'relationship_type_lovedby_reverse_female' => 'amoureuse de',
    ...
    'relationship_type_lovedby_reverse_with_name' => 'une personne dont :name est amoureux·se',
    'relationship_type_lovedby_reverse_female_with_name' => 'une personne dont :name est amoureux·se',
    ...
    'relationship_type_ex_reverse_female_with_name' => 'ex-petite amie de :name',
    ...
    'relationship_type_grandparent_reverse' => 'petit-fils',
    'relationship_type_grandparent_reverse_female' => 'petite-fille',
    ...
    'relationship_type_grandparent_reverse_with_name' => 'petit-fils de :name',
    'relationship_type_grandparent_reverse_female_with_name' => 'petite-fille de :name',

    'relationship_type_grandchild' => 'petit-fils',
    'relationship_type_grandchild_female' => 'petite-fille',
    'relationship_type_grandchild_reverse' => 'grand-père',
    'relationship_type_grandchild_reverse_female' => 'grand-mère',
    ...
    'relationship_type_grandchild_reverse_with_name' => 'grand-père de :name',
    'relationship_type_grandchild_reverse_female_with_name' => 'grand-mère de :name',
    ...
    'relationship_type_cousin_reverse_female' => 'cousine',
    ...
    'relationship_type_cousin_reverse_female_with_name' => 'cousine de :name',
    ...
    'relationship_type_friend_reverse' => 'ami',
    'relationship_type_friend_reverse_female' => 'amie',
    'relationship_type_friend_with_name' => 'ami de :name',
    'relationship_type_friend_female_with_name' => 'amie de :name',
    'relationship_type_friend_reverse_with_name' => 'ami de :name',
    'relationship_type_friend_reverse_female_with_name' => 'amie de :name',

    'relationship_type_bestfriend' => 'meilleur ami',
    'relationship_type_bestfriend_female' => 'meilleure amie',
    'relationship_type_bestfriend_reverse' => 'meilleur ami',
    'relationship_type_bestfriend_reverse_female' => 'meilleure amie',
    ...
    'relationship_type_bestfriend_reverse_with_name' => 'meilleur ami de :name',
    'relationship_type_bestfriend_reverse_female_with_name' => 'meilleure amie de :name',
    ...
    'relationship_type_boss_reverse' => 'employé',
    'relationship_type_boss_reverse_female' => 'employée',
    'relationship_type_boss_with_name' => 'patron de :name',
    'relationship_type_boss_female_with_name' => 'patronne de :name',
    'relationship_type_boss_reverse_with_name' => 'employé de :name',
    'relationship_type_boss_reverse_female_with_name' => 'employée de :name',
    ...
    'relationship_type_subordinate_reverse_female' => 'patronne',
    ...
    'relationship_type_subordinate_reverse_female_with_name' => 'patronne de :name',

    'relationship_type_mentor' => 'mentor',
    'relationship_type_mentor_female' => 'mentore',
    'relationship_type_mentor_reverse' => 'protégé',
    'relationship_type_mentor_reverse_female' => 'protégée',
    ...
    'relationship_type_mentor_reverse_female_with_name' => 'protégée de :name',

    'relationship_type_protege' => 'protégé',
    'relationship_type_protege_female' => 'protégée',
    'relationship_type_protege_reverse' => 'mentor',
    'relationship_type_protege_reverse_female' => 'mentore',
    ...
    'relationship_type_protege_reverse_female_with_name' => 'mentore de :name',
];
