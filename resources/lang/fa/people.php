...
return [
    ...
    'people_list_number_kids' => ':count بچه|:count بچه',
    'people_list_last_updated' => 'آخرین مشاوره:',
    'people_list_number_reminders' => ':count یادآوری|:count یادآوری',
    'people_list_blank_title' => 'شما هنوز کسی را در اکانتتان ندارید',
    'people_list_blank_cta' => 'یک نفر رو اضافه کنید',
    'people_list_sort' => 'مرتب سازی',
    'people_list_stats' => ':count مخاطب|:count مخاطب',
    'people_list_firstnameAZ' => 'مرتب سازی نام از "الف" تا "ی"',
    'people_list_firstnameZA' => 'مرتب سازی نام از  "ی" تا "الف" ',
    'people_list_lastnameAZ' => 'مرتب سازی نام خانوادگی از "الف" تا "ی"',
    'people_list_lastnameZA' => 'مرتب سازی نام خانوادگی از  "ی" تا "الف" ',
    'people_list_lastactivitydateNewtoOld' => 'مرتب سازی آخرین فعالیت ها بر اساس تاریخ نزدیک به دور',
    'people_list_lastactivitydateOldtoNew' => 'مرتب سازی آخرین فعالیت ها بر اساس تاریخ دور به نزدیک',
    'people_list_filter_tag' => 'نمایش همه ی مخاطبینی که برچسب گذاری شده اند با ',
    'people_list_clear_filter' => 'پاک کردن فيلتر',
    'people_list_contacts_per_tags' => ':count مخاطب|:count مخاطب',
    'people_list_show_dead' => 'نمایش افراد فوت شده (:count)',
    'people_list_hide_dead' => 'مخفی کردن افراد فوت شده (:count)',
    'people_search' => 'مخاطبین خود را بیابید...',
    'people_search_no_results' => 'نتایجی پیدا نشد',
    'people_search_next' => 'بعدی',
    'people_search_prev' => 'قبلی',
    'people_search_rows_per_page' => 'تعداد در هر صفحه',
    'people_search_of' => 'از',
    'people_search_page' => 'صفحه',
    'people_search_all' => 'همه',
    'people_add_new' => 'افزودن فرد جدید',
    'people_list_account_usage' => 'استفاده از حساب: :current/:limit مخاطب',
    'people_list_account_upgrade_title' => 'اکانت خود را برای استفاده از تمام پتانسیل ها ارتقا دهید.',
    'people_list_account_upgrade_cta' => 'هم اکنون ارتقا داده شود',
    'people_list_untagged' => 'مشاهده کاربران تگ نشده',
    'people_list_filter_untag' => 'نمایش تمامی کاربران تگ نشده',
    'archived_contact_readonly' => 'مخاطبین آرشیو شده قابل ویرایش نیستند،لطفا ابتدا از آرشیو دربیارید.',

    // people add
    'people_add_title' => 'افزودن فرد جدید',
    'people_add_missing' => 'فردی پیدا نشد - اکنون فرد جدیدی اضافه کنید',
    'people_add_firstname' => 'نام',
    'people_add_middlename' => 'نام میانی (اختیاری)',
    'people_add_lastname' => 'نام خانوادگی (اختیاری)',
    'people_add_email' => 'رایانامه (اختیاری)',
    'people_add_nickname' => 'نام مستعار (اختیاری)',
    'people_add_cta' => 'افزودن',
    'people_save_and_add_another_cta' => 'ذخیره و افزودن فرد دیگر',
    'people_add_success' => ':name با موفقیت ساخته شد',
    'people_add_gender' => 'جنسیت',
    'people_delete_success' => 'مخاطب حذف شد',
    'people_delete_message' => 'حذف مخاطب',
    'people_delete_confirmation' => 'از حذف مخاطب ( :name ) اطمینان دارید؟ حذف به صورت کامل و دائمی است.',
    'people_add_birthday_reminder' => 'تولدت مبارک :name',
    'people_add_birthday_reminder_deceased' => 'در این تاریخ  :name ، حتما تولدش را جشن گرفته ',
    'people_add_import' => 'تمایل دارید <a href=":url">مخاطبی خود را درون ریزی کنید</a>؟',
