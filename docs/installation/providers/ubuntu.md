...
Then install php 8.0 with these extensions:

```sh
sudo apt update
sudo apt install -y php8.0 php8.0-bcmath php8.0-cli php8.0-curl php8.0-common \
    php8.0-fpm php8.0-gd php8.0-gmp php8.0-intl php8.0-mbstring php8.0-mysql \
    php8.0-opcache php8.0-redis php8.0-xml php8.0-zip
```
...
# Enable php8.0 fpm, and restart apache
