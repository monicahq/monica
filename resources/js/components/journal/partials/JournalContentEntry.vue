      ...
      <div class="br3 ba b--gray-monica bg-white pr3 pb3 pt3 mb3 journal-line">
        <div class="flex">
          ...
          <div class="flex-auto">
            ...
            <ul class="f7">
              <li class="di">
                <a class="pointer" v-cy-name="'entry-edit-button-' + entry.id" :href="'journal/entries/' + entry.id + '/edit'">
                  {{ $t('app.edit') }}
                </a>
              </li>
              <li class="di">
                <a class="pointer" v-cy-name="'entry-delete-button-' + entry.id" href="" @click.prevent="trash()">
                  {{ $t('app.delete') }}
                </a>
              </li>
            </ul>
