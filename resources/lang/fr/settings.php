...
return [
    ...
    'api_oauth_clients_desc2' => 'Utilisez cet identifiant de client pour demander un nouveau jeton et convertir les codes d’autorisation pour accéder aux jetons. Voir <a href="{url}">la documentation de Laravel Passport</a> pour plus d’explications.',
    ...
    'api_authorized_clients_desc' => 'Cette section liste tous les clients que vous avez autorisés à accéder aux données de votre demande. Vous pouvez révoquer cette autorisation à tout moment.',
